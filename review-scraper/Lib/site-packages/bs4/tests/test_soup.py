...
import pytest
from bs4 import (BeautifulSoup, BeautifulStoneSoup, GuessedAtParserWarning,
                 MarkupResemblesLocatorWarning, dammit)
from bs4.builder import ParserRejectedMarkup, TreeBuilder, builder_registry
from bs4.element import (PYTHON_SPECIFIC_ENCODINGS, Comment, NavigableString,
                         SoupStrainer, Tag)
