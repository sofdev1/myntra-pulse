...
from bs4.builder import (DetectsXMLParsedAsHTML, HTMLParserTreeBuilder,
                         XMLParsedAsHTMLWarning)
from bs4.element import (PYTHON_SPECIFIC_ENCODINGS, CharsetMetaAttributeValue,
                         Comment, ContentMetaAttributeValue, Doctype, Script,
                         SoupStrainer, Stylesheet, Tag)
