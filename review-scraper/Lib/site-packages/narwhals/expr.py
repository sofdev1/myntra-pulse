...
from narwhals._utils import (NO_DEFAULT, _validate_rolling_arguments,
                             ensure_type, flatten, unstable)
...
if TYPE_CHECKING:
    ...
    from narwhals.typing import (ClosedInterval, FillNullStrategy, IntoDType,
                                 IntoExpr, ModeKeepStrategy, NonNestedLiteral,
                                 NumericLiteral, RankMethod,
