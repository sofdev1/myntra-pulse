...
from narwhals._polars.utils import (BACKEND_VERSION,
                                    ...
                                    PolarsAnyNamespace, PolarsCatNamespace,
                                    PolarsDateTimeNamespace,
                                    PolarsListNamespace, PolarsStringNamespace,
                                    PolarsStructNamespace, extract_args_kwargs,
                                    extract_native, narwhals_to_native_dtype)
    ...
    def map_batches(
        ...
        *,
        ...
        return_dtype_pl = (
            ...
            else None if pl_version < (1, 32) else pl.self_dtype()
        )
