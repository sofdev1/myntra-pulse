...
from narwhals._polars.utils import (FROM_DICTS_ACCEPTS_MAPPINGS,
                                    RESPECT_JOIN_NULL_SEMI_ANTI,
                                    catch_polars_exception,
                                    extract_args_kwargs,
                                    narwhals_to_native_dtype,
                                    native_to_narwhals_dtype)
from narwhals._utils import (Implementation, _into_arrow_table,
                             convert_str_slice_to_int_slice,
                             generate_temporary_column_name,
                             is_boolean_selector, is_compliant_series,
                             is_index_selector, is_range, is_sequence_like,
                             is_slice_index, is_slice_none,
                             parse_columns_to_drop, requires)
...
if TYPE_CHECKING:
    ...
    from narwhals.typing import (IntoDType, JoinStrategy, MultiColSelector,
                                 MultiIndexSelector, PivotAgg,
                                 SingleIndexSelector, UniqueKeepStrategy,
                                 _2DArray)
