...
from narwhals._native import (is_native_arrow, is_native_pandas_like,
                              is_native_polars, is_native_spark_like)
from narwhals._utils import (Implementation, Version, has_native_namespace,
                             is_compliant_dataframe, is_compliant_lazyframe,
                             is_compliant_series)
from narwhals.dependencies import (get_dask_expr, get_numpy, get_pandas,
                                   is_cupy_scalar, is_dask_dataframe,
                                   is_duckdb_relation, is_ibis_table,
                                   is_numpy_scalar, is_pandas_like_dataframe,
                                   is_polars_lazyframe, is_polars_series,
                                   is_pyarrow_scalar, is_pyarrow_table)

if TYPE_CHECKING:
    from collections.abc import Callable

    from narwhals._translate import (AllowAny, AllowLazy, AllowSeries,
                                     ExcludeSeries, OnlySeries,
                                     PassThroughUnknown)
    from narwhals.dataframe import DataFrame, LazyFrame
    from narwhals.series import Series
    from narwhals.typing import (DataFrameT, Frame, IntoDataFrameT, IntoFrame,
