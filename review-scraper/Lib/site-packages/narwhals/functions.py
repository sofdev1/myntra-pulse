...
from narwhals._expression_parsing import (ExprKind, ExprNode, _parse_into_expr,
                                          is_expr, is_series)
from narwhals._utils import (Implementation, Version,
                             deprecate_native_namespace, flatten,
                             is_eager_allowed, is_nested_literal,
                             is_sequence_of, normalize_path,
                             supports_arrow_c_stream, validate_laziness)
from narwhals.dependencies import (is_narwhals_series, is_numpy_array,
                                   is_numpy_array_2d, is_pyarrow_table)
...
if TYPE_CHECKING:
    ...
    from narwhals.typing import (ConcatMethod, CorrelationMethod, FileSource,
                                 FrameT, IntoDType, IntoExpr, IntoSchema,
                                 NonNestedLiteral, PythonLiteral, _2DArray)
