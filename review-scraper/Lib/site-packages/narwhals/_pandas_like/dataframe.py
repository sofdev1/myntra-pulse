...
from narwhals._utils import (Implementation, _into_arrow_table,
                             ...
                             parse_columns_to_drop, scale_bytes)
...
if TYPE_CHECKING:
    ...
    from narwhals.typing import (AsofJoinStrategy, DTypeBackend, IntoDType,
                                 JoinStrategy, PivotAgg,
        ...
        if implementation.is_pandas():
            ...
            if implementation._backend_version() >= (0, 26, 0):
                ...
                from modin.pandas.utils import \
                    from_arrow as \
                    mpd_from_arrow  # pyright: ignore[reportAttributeAccessIssue]
