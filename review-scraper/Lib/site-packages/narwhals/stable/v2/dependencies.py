...
from narwhals.dependencies import (_is_native_dataframe, _is_native_lazyframe,
                                   _is_native_series, get_cudf, get_dask,
                                   get_dask_dataframe, get_duckdb, get_ibis,
                                   get_modin, get_numpy, get_pandas,
                                   get_polars, get_pyarrow, get_pyspark,
                                   get_pyspark_connect, get_pyspark_sql,
                                   get_sqlframe, is_cudf_dataframe,
                                   is_cudf_index, is_cudf_series,
                                   is_dask_dataframe, is_duckdb_relation,
                                   is_ibis_table, is_modin_dataframe,
                                   is_modin_index, is_modin_series,
                                   is_narwhals_dataframe,
                                   is_narwhals_lazyframe, is_narwhals_series,
                                   is_numpy_array, is_pandas_dataframe,
                                   is_pandas_index, is_pandas_like_dataframe,
                                   is_pandas_like_index, is_pandas_like_series,
                                   is_pandas_series, is_polars_dataframe,
                                   is_polars_lazyframe, is_polars_series,
                                   is_pyarrow_chunked_array, is_pyarrow_table,
                                   is_pyspark_connect_dataframe,
                                   is_pyspark_dataframe, is_sqlframe_dataframe)
