...
from narwhals.dependencies import _is_cudf_dataframe as is_cudf_dataframe
from narwhals.dependencies import _is_cudf_series as is_cudf_series
from narwhals.dependencies import _is_dask_dataframe as is_dask_dataframe
from narwhals.dependencies import _is_duckdb_relation as is_duckdb_relation
from narwhals.dependencies import _is_ibis_table as is_ibis_table
from narwhals.dependencies import _is_modin_dataframe as is_modin_dataframe
from narwhals.dependencies import _is_modin_series as is_modin_series
from narwhals.dependencies import (_is_native_dataframe, _is_native_lazyframe,
                                   _is_native_series)
from narwhals.dependencies import _is_pandas_dataframe as is_pandas_dataframe
from narwhals.dependencies import \
    _is_pandas_like_dataframe as is_pandas_like_dataframe
from narwhals.dependencies import \
    _is_pandas_like_series as is_pandas_like_series
from narwhals.dependencies import _is_pandas_series as is_pandas_series
from narwhals.dependencies import _is_polars_dataframe as is_polars_dataframe
from narwhals.dependencies import _is_polars_lazyframe as is_polars_lazyframe
from narwhals.dependencies import _is_polars_series as is_polars_series
from narwhals.dependencies import \
    _is_pyarrow_chunked_array as is_pyarrow_chunked_array
from narwhals.dependencies import _is_pyarrow_table as is_pyarrow_table
from narwhals.dependencies import \
    _is_pyspark_connect_dataframe as is_pyspark_connect_dataframe
from narwhals.dependencies import _is_pyspark_dataframe as is_pyspark_dataframe
from narwhals.dependencies import \
    _is_sqlframe_dataframe as is_sqlframe_dataframe
from narwhals.dependencies import (get_cudf, get_dask, get_dask_dataframe,
                                   get_duckdb, get_ibis, get_modin, get_numpy,
                                   get_pandas, get_polars, get_pyarrow,
                                   get_pyspark, get_pyspark_connect,
                                   get_pyspark_sql, get_sqlframe,
                                   is_cudf_index, is_modin_index,
                                   is_narwhals_dataframe,
                                   is_narwhals_lazyframe, is_narwhals_series,
                                   is_numpy_array, is_pandas_index,
