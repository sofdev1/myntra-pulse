...
if TYPE_CHECKING:
    ...
    from narwhals._arrow.typing import (ArrayAny, ArrayOrScalar,
                                        ArrayOrScalarT1, ArrayOrScalarT2,
                                        ChunkedArrayAny, Incomplete,
                                        NativeIntervalUnit, PromoteOptions,
                                        ScalarAny)
    ...
    from pyarrow.types import (is_duration, is_fixed_size_list, is_large_list,
                               is_list, is_timestamp)
...
def list_sort(
    ...
    if BACKEND_VERSION < (25,):  # pragma: no cover
        ...
        keyed = [
            (idx, "ascending", nulls_position),
            (v, sort_direction, nulls_position),
        ]
