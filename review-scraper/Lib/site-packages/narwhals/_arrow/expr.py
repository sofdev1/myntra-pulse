...
from narwhals._expression_parsing import (evaluate_nodes,
...
class ArrowExpr(EagerExpr["ArrowDataFrame", ArrowSeries]):
    ...
    def over(self, partition_by: Sequence[str], order_by: Sequence[str]) -> Self:
        ...
        def func(df: ArrowDataFrame) -> Sequence[ArrowSeries]:  # noqa: PLR0914
            ...
            for col_name, has_null in zip(
                partition_tbl.columns, has_nulls, strict=False
            ):
                if not has_null:
            ...
            windowed = tbl_encoded.group_by(group_keys, drop_null_keys=False).agg(
                leaf_ce
            )
