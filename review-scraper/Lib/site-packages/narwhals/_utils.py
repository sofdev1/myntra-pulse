...
from narwhals.dependencies import (get_cudf, get_dask_dataframe, get_duckdb,
                                   get_ibis, get_modin, get_pandas, get_polars,
                                   get_pyarrow, get_pyspark_connect,
                                   get_pyspark_sql, get_sqlframe,
                                   is_narwhals_series, is_narwhals_series_bool,
                                   is_narwhals_series_int, is_numpy_array_1d,
...
if TYPE_CHECKING:
    ...
    from narwhals._compliant import (CompliantExprT, CompliantSeriesT,
                                     NativeSeriesT_co)
    from narwhals._compliant.any_namespace import NamespaceAccessor
    from narwhals._compliant.typing import (Accessor, EvalNames,
                                            NativeDataFrameT, NativeLazyFrameT)
    from narwhals._namespace import Namespace
    from narwhals._native import (NativeArrow, NativeCuDF, NativeDask,
                                  NativeDuckDB, NativeIbis, NativeModin,
                                  NativePandas, NativePandasLike, NativePolars,
                                  NativePySpark, NativePySparkConnect,
                                  NativeSQLFrame)
    from narwhals._translate import (ArrowStreamExportable, IntoArrowTable,
                                     ToNarwhalsT_co)
    from narwhals._typing import (Backend, IntoBackend, _ArrowImpl, _CuDFImpl,
                                  _DaskImpl, _DuckDBImpl, _EagerAllowedImpl,
                                  _IbisImpl, _LazyAllowedImpl,
                                  _LazyFrameCollectImpl, _ModinImpl,
                                  _PandasImpl, _PandasLikeImpl, _PolarsImpl,
                                  _PySparkConnectImpl, _PySparkImpl,
                                  _SQLFrameImpl)
    from narwhals.dataframe import DataFrame, LazyFrame
    from narwhals.dtypes import DType
    from narwhals.series import Series
    from narwhals.typing import (CompliantDataFrame, CompliantLazyFrame,
                                 CompliantSeries, DTypes, FileSource,
                                 IntoSeriesT, MultiIndexSelector,
                                 NestedLiteral, SingleIndexSelector,
                                 SizedMultiBoolSelector,
                                 SizedMultiIndexSelector, SizeUnit,
                                 SupportsNativeNamespace, TimeUnit, _1DArray,
                                 _SliceIndex, _SliceName, _SliceNone)
