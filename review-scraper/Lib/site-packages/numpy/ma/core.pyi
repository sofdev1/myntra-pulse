...
from typing import (Any, Concatenate, Final, Generic, Literal, Never, NoReturn,
                    Protocol, Self, SupportsComplex, SupportsFloat,
                    SupportsIndex, SupportsInt, Unpack, final, overload,
                    override, type_check_only)

import numpy as np
from _typeshed import Incomplete, SupportsLenAndGetItem
from numpy import (_HasDType, _HasDTypeWithRealAndImag, _ModeKind, _OrderACF,
                   _OrderCF, _OrderKACF, _PartitionKind, _SortKind, _ToIndices,
                   amax, amin, bool_, bytes_, complex128, complexfloating,
                   datetime64, dtype, expand_dims, float64, floating, generic,
                   inexact, int8, int64, int_, integer, intp, ndarray, number,
                   object_, signedinteger, str_, timedelta64, unsignedinteger)
...
type _Masked3D[ScalarT: np.generic] = MaskedArray[
    tuple[int, int, int], np.dtype[ScalarT]
]

type _MaskedArrayUInt_co = _MaskedArray[np.unsignedinteger | np.bool]
type _MaskedArrayInt_co = _MaskedArray[np.integer | np.bool]
type _MaskedArrayFloat64_co = _MaskedArray[
...
type _MaskedArrayComplex128_co = _MaskedArray[
...
type _ArrayNoD[ScalarT: np.generic] = np.ndarray[
    tuple[Never] | tuple[Never, Never], np.dtype[ScalarT]
]
...
class _extrema_operation(_MaskedUFunc[_UFuncT_co], Generic[_UFuncT_co]):
    ...
    def __call__[ScalarT: np.generic](
        self, /, a: _ArrayLike[ScalarT], b: _ArrayLike[ScalarT]
...
@overload
def common_fill_value[ScalarT: np.generic](
    a: _MaskedArray[ScalarT], b: MaskedArray
) -> ScalarT | None: ...
@overload
...
@overload
def filled[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], fill_value: _ScalarLike_co | None = None
) -> NDArray[ScalarT]: ...
@overload
def filled(
...
@overload
def getdata[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], subok: bool = True
) -> NDArray[ScalarT]: ...
@overload
...
@overload
def getmask[ShapeT: _Shape](
    a: MaskedArray[ShapeT, Any],
...
@overload
def getmaskarray[ShapeT: _Shape](
    arr: np.ndarray[ShapeT, Any],
) -> _MaskArray[ShapeT]: ...
...
def make_mask_none[ShapeT: _Shape](
    newshape: ShapeT, dtype: np.dtype | type | str | None = None
) -> _MaskArray[ShapeT]: ...
@overload  # known shape, dtype: structured
def make_mask_none[ShapeT: _Shape](
    newshape: ShapeT, dtype: _VoidDTypeLike
) -> np.ndarray[ShapeT, dtype[np.void]]: ...
...
@overload
def flatten_structured_array[ShapeT: _Shape](
    a: MaskedArray[ShapeT, np.dtype[np.void]],
) -> MaskedArray[ShapeT]: ...
@overload
def flatten_structured_array[ShapeT: _Shape](
...
def masked_invalid[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], copy: bool = True
) -> _MaskedArray[ScalarT]: ...
...
@overload  # array-like of known scalar-type
def masked_greater[ScalarT: np.generic](
    x: _ArrayLike[ScalarT], value: ArrayLike, copy: bool = True
) -> _MaskedArray[ScalarT]: ...
@overload  # unknown array-like
def masked_greater(
...
@overload  # array-like of known scalar-type
def masked_less[ScalarT: np.generic](
    x: _ArrayLike[ScalarT], value: ArrayLike, copy: bool = True
) -> _MaskedArray[ScalarT]: ...
@overload  # unknown array-like
def masked_less(
...
@overload  # array-like of known scalar-type
def masked_equal[ScalarT: np.generic](
    x: _ArrayLike[ScalarT], value: ArrayLike, copy: bool = True
) -> _MaskedArray[ScalarT]: ...
@overload  # unknown array-like
def masked_equal(
...
class MaskedIterator(Generic[_ShapeT_co, _DTypeT_co]):
    ...
    def __setitem__(
        self: MaskedIterator[
            Any, dtype[np.flexible | object_ | np.bool] | np.dtypes.StringDType
        ],
        index: _ToIndices,
        value: object,
        /,
    ...
    def __next__[ScalarT: np.generic](
        self: MaskedIterator[Any, np.dtype[ScalarT]],
    ) -> ScalarT: ...
...
class MaskedArray(ndarray[_ShapeT_co, _DTypeT_co]):
    ...
    @overload
    def __getitem__(
        self: _MaskedArray[np.void], indx: str, /
    ) -> MaskedArray[_ShapeT_co]: ...
    @overload
    def __getitem__(
        self: _MaskedArray[np.void], indx: list[str], /
    ) -> MaskedArray[_ShapeT_co, np.dtype[np.void]]: ...
    @property
    def shape(self) -> _ShapeT_co: ...
    @shape.setter  # type: ignore[override]
    def shape[ShapeT: _Shape](
        self: MaskedArray[ShapeT, Any], shape: ShapeT, /
    ) -> None: ...
    ...
    @overload
    def __add__[ScalarT: np.number](
        self: _MaskedArray[ScalarT], other: _ArrayLikeBool_co, /
    ) -> _MaskedArray[ScalarT]: ...
    @overload
    def __add__(
    ...
    @overload
    def __add__[ScalarT: np.number](
        self: _MaskedArray[np.bool], other: _ArrayLike[ScalarT], /
    ) -> _MaskedArray[ScalarT]: ...
    @overload
    def __add__(
    ...
    @overload
    def __add__(
        self: _MaskedArrayUInt_co, other: _ArrayLikeUInt_co, /
    ) -> _MaskedArray[unsignedinteger]: ...
    @overload
    def __add__(
        self: _MaskedArrayInt_co, other: _ArrayLikeInt_co, /
    ) -> _MaskedArray[signedinteger]: ...
    @overload
    def __add__(
    ...
    @overload
    def dot[ArrayT: np.ndarray](
        self, b: ArrayLike, out: ArrayT, strict: bool = False
    ) -> ArrayT: ...
    ...
    @overload
    def tolist[T](
        self: MaskedArray[tuple[Never], np.dtype[generic[T]]],
        /,
        fill_value: _ScalarLike_co | None = None,
    ) -> Any: ...
    @overload
    def tolist[T](
        self: MaskedArray[tuple[()], np.dtype[generic[T]]],
        /,
        fill_value: _ScalarLike_co | None = None,
    ) -> T: ...
    @overload
    def tolist[T](
        self: _Masked1D[np.generic[T]], /, fill_value: _ScalarLike_co | None = None
    ) -> list[T]: ...
    @overload
    def tolist[T](
    ...
    @dtype.setter
    def dtype[DTypeT: np.dtype](
        self: MaskedArray[_AnyShape, DTypeT], dtype: DTypeT, /
    ) -> None: ...
...
class mvoid(MaskedArray[_ShapeT_co, _DTypeT_co]):
    ...
    @override
    def __iter__[ScalarT: np.generic](
        self: mvoid[Any, np.dtype[ScalarT]], /
    ) -> Iterator[MaskedConstant | ScalarT]: ...
    @override
...
@overload
def asanyarray[MArrayT: MaskedArray](
    a: MArrayT, dtype: None = None, order: _OrderKACF | None = None
) -> MArrayT: ...
@overload
...
@overload
def ravel[DTypeT: np.dtype](
    a: np.ndarray[Any, DTypeT], order: _OrderKACF = "C"
) -> MaskedArray[tuple[int], DTypeT]: ...
@overload
def ravel[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], order: _OrderKACF = "C"
) -> _Masked1D[ScalarT]: ...
@overload
def ravel(
...
def repeat[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], repeats: _ArrayLikeInt_co, axis: None = None
) -> _Masked1D[ScalarT]: ...
@overload
def repeat[ScalarT: np.generic](
    a: _ArrayLike[ScalarT],
...
@overload
def swapaxes[MArrayT: MaskedArray](
    a: MArrayT, axis1: SupportsIndex, axis2: SupportsIndex
) -> MArrayT: ...
@overload
...
def anom[MArrayT: MaskedArray](
    a: MArrayT, axis: SupportsIndex | None = None, dtype: None = None
) -> MArrayT: ...
...
def anom[ScalarT: np.generic](
    a: ArrayLike, axis: SupportsIndex | None, dtype: _DTypeLike[ScalarT]
) -> _MaskedArray[ScalarT]: ...
...
@overload
def compress[ArrayT: np.ndarray](
    condition: _ArrayLikeBool_co, a: ArrayLike, axis: _ShapeLike | None, out: ArrayT
) -> ArrayT: ...
@overload
def compress[ArrayT: np.ndarray](
    condition: _ArrayLikeBool_co,
...
def cumsum[ArrayT: np.ndarray](
    a: ArrayLike, axis: SupportsIndex | None, dtype: DTypeLike | None, out: ArrayT
) -> ArrayT: ...
...
#
def power(
    a: ArrayLike, b: ArrayLike, third: None = None
) -> _MaskedArray[Incomplete]: ...
...
def concatenate[ScalarT: np.generic](
    arrays: _ArrayLike[ScalarT], axis: SupportsIndex | None = 0
) -> _MaskedArray[ScalarT]: ...
@overload
def concatenate(
    arrays: SupportsLenAndGetItem[ArrayLike], axis: SupportsIndex | None = 0
) -> _MaskedArray[Incomplete]: ...

# keep in sync with `diag` and `lib._twodim_base_impl.diag`
@overload
def diag[ScalarT: np.generic](
    v: _ArrayNoD[ScalarT] | Sequence[Sequence[ScalarT]], k: int = 0
) -> _MaskedArray[ScalarT]: ...
@overload
def diag[ScalarT: np.generic](
    v: _Array2D[ScalarT] | Sequence[Sequence[ScalarT]], k: int = 0
) -> _Masked1D[ScalarT]: ...
@overload
def diag[ScalarT: np.generic](
    v: _Array1D[ScalarT] | Sequence[ScalarT], k: int = 0
) -> _Masked2D[ScalarT]: ...
@overload
def diag(
    v: Sequence[Sequence[_ScalarLike_co]], k: int = 0
) -> _Masked1D[Incomplete]: ...
@overload
def diag(v: Sequence[_ScalarLike_co], k: int = 0) -> _Masked2D[Incomplete]: ...
@overload
def diag[ScalarT: np.generic](
    v: _ArrayLike[ScalarT], k: int = 0
) -> _MaskedArray[ScalarT]: ...
@overload
...
@overload
def left_shift[ScalarT: np.bool | np.integer | np.object_](
    a: _ArrayLike[ScalarT], n: int
) -> _MaskedArray[ScalarT]: ...
@overload
...
@overload
def right_shift[ScalarT: np.bool | np.integer | np.object_](
    a: _ArrayLike[ScalarT], n: int
) -> _MaskedArray[ScalarT]: ...
@overload
...
@overload
def transpose[ArrayT: np.ndarray](
    a: ArrayT, axes: _ShapeLike | None = None
) -> ArrayT: ...
@overload
def transpose[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], axes: _ShapeLike | None = None
) -> _MaskedArray[ScalarT]: ...
...
@overload  # shape: index
def reshape(
    a: ArrayLike, new_shape: SupportsIndex, order: _OrderACF = "C"
) -> _Masked1D[Incomplete]: ...
@overload  # shape: ~ShapeT
def reshape[ShapeT: _Shape](
    a: ArrayLike, new_shape: ShapeT, order: _OrderACF = "C"
) -> MaskedArray[ShapeT]: ...
@overload  # shape: Sequence[index]
def reshape(
    a: ArrayLike, new_shape: Sequence[SupportsIndex], order: _OrderACF = "C"
) -> _MaskedArray[Incomplete]: ...
...
@overload
def resize[ScalarT: np.generic](
    x: _ArrayLike[ScalarT], new_shape: _ShapeLike
) -> _MaskedArray[ScalarT]: ...
@overload
def resize(
    x: ArrayLike, new_shape: SupportsIndex | tuple[SupportsIndex]
) -> _Masked1D[Incomplete]: ...
@overload
...
def round[MArray: MaskedArray](
    a: MArray, decimals: int = 0, out: None = None
) -> MArray: ...
@overload  # a: known array-like, out: None (default)
def round[ScalarT: np.number](
    a: _ArrayLike[ScalarT], decimals: int = 0, out: None = None
) -> _MaskedArray[ScalarT]: ...
@overload  # a: unknown array-like, out: None (default)
def round(
    a: _ArrayLikeNumber_co, decimals: int = 0, out: None = None
) -> _MaskedArray[Incomplete]: ...
@overload  # out: ndarray (positional)
def round[ArrayT: np.ndarray](a: ArrayLike, decimals: int, out: ArrayT) -> ArrayT: ...
@overload  # out: ndarray (keyword)
def round[ArrayT: np.ndarray](
    a: ArrayLike, decimals: int = 0, *, out: ArrayT
) -> ArrayT: ...

#
@overload  # a: masked_array, out: None (default)
@deprecated("numpy.ma.round_ is deprecated. Use numpy.ma.round instead.")
def round_[MArray: MaskedArray](
    a: MArray, decimals: int = 0, out: None = None
) -> MArray: ...
@overload  # a: known array-like, out: None (default)
@deprecated("numpy.ma.round_ is deprecated. Use numpy.ma.round instead.")
def round_[ScalarT: np.number](
    a: _ArrayLike[ScalarT], decimals: int = 0, out: None = None
) -> _MaskedArray[ScalarT]: ...
@overload  # a: unknown array-like, out: None (default)
@deprecated("numpy.ma.round_ is deprecated. Use numpy.ma.round instead.")
...
@overload  # out: ndarray (keyword)
@deprecated("numpy.ma.round_ is deprecated. Use numpy.ma.round instead.")
def round_[ArrayT: np.ndarray](
    a: ArrayLike, decimals: int = 0, *, out: ArrayT
) -> ArrayT: ...

# keep in sync with `_core.multiarray.inner`
@overload  # (?d T, Nd T) -> 0d|Nd T  (workaround)
def inner[ScalarT: _InnerScalar | np.object_](
    a: _ArrayNoD[ScalarT], b: _ArrayLike[ScalarT]
) -> _MaskedArray[ScalarT] | Any: ...
@overload  # (Nd T, ?d T) -> 0d|Nd T  (workaround)
def inner[ScalarT: _InnerScalar | np.object_](
    a: _ArrayLike[ScalarT], b: _ArrayNoD[ScalarT]
) -> _MaskedArray[ScalarT] | Any: ...
@overload  # (1d T, 1d T) -> 0d T
def inner[ScalarT: _InnerScalar](
    a: _ToArray1D[ScalarT], b: _ToArray1D[ScalarT]
) -> ScalarT: ...
@overload  # (1d object_, 1d _) -> 0d object
def inner(
    a: _Array1D[np.object_], b: _Array1D[np.object_] | _ToArray1D[_InnerScalar]
) -> Any: ...
...
def inner[ScalarT: _InnerScalar | np.object_](
    a: _ToArray1D[ScalarT], b: _Array2D[ScalarT]
) -> _Masked1D[ScalarT]: ...
@overload  # (2d T, 1d T) -> 1d T
def inner[ScalarT: _InnerScalar | np.object_](
    a: _ToArray2D[ScalarT], b: _Array1D[ScalarT]
) -> _Masked1D[ScalarT]: ...
@overload  # (2d T, 2d T) -> 2d _Masked1D
def inner[ScalarT: _InnerScalar | np.object_](
    a: _ToArray2D[ScalarT], b: _Array2D[ScalarT]
) -> _Masked2D[ScalarT]: ...
@overload  # fallback
...
@overload
def outer(
    a: _ArrayLike[_AnyNumericScalarT], b: _ArrayLike[_AnyNumericScalarT]
) -> _Masked2D[_AnyNumericScalarT]: ...  # noqa: UP047
@overload
...
@overload
def outer(
    a: _ArrayLikeFloat_co, b: _ArrayLikeFloat_co
) -> _Masked2D[np.float64 | Any]: ...
@overload
def outer(
    a: _ArrayLikeComplex_co, b: _ArrayLikeComplex_co
) -> _Masked2D[np.complex128 | Any]: ...
@overload
def outer(
    a: _ArrayLikeTD64_co, b: _ArrayLikeTD64_co
) -> _Masked2D[np.timedelta64 | Any]: ...
...
#
def fromflex[ShapeT: _Shape](
    fxarray: np.ndarray[ShapeT, np.dtype[np.void]],
...
@overload
def dot(
    a: ArrayLike, b: ArrayLike, strict: bool = False, out: None = None
) -> Incomplete: ...
@overload
def dot[OutT: np.ndarray](
    a: ArrayLike, b: ArrayLike, strict: bool = False, *, out: OutT
) -> OutT: ...
