...
from numpy._typing import (ArrayLike, DTypeLike, _AnyShape, _ArrayLikeBool_co,
                           _DTypeLike, _HasDType, _ScalarLike_co, _Shape,
                           _ShapeLike, _VoidDTypeLike)
...
class MaskedRecords(
    ...
    @overload  # ()
    def view(
        self, /, dtype: None = None, type: None = None
    ) -> Self: ...  # pyrefly: ignore[bad-override]
    ...
    def view[ArrayT: np.ndarray](
        self, /, dtype: DTypeLike | None = None, *, type: type[ArrayT]
    ) -> ArrayT: ...
    @overload  # (dtype: _, type: ArrayT)
    def view[ArrayT: np.ndarray](
        self, /, dtype: DTypeLike | None, type: type[ArrayT]
    ) -> ArrayT: ...
    @overload  # (dtype: ArrayT, /)
    def view[ArrayT: np.ndarray](
        self, /, dtype: type[ArrayT], type: None = None
    ) -> ArrayT: ...
    @overload  # (dtype: <like `DTypeLike` but without `_DTypeLike[Any]`>)
    def view(
        self, /, dtype: _VoidDTypeLike | str | None, type: None = None
    ) -> MaskedRecords[
        _ShapeT_co, np.dtype
