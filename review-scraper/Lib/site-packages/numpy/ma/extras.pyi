...
from typing import SupportsIndex, TypeVar, overload, override
...
from numpy._typing import (ArrayLike, DTypeLike, NDArray, _AnyShape,
                           ...
                           _NestedSequence, _NumberLike_co, _Shape, _ShapeLike)
...
type _5Tup[T] = tuple[
    T, NDArray[np.float64], NDArray[np.int32], NDArray[np.float64], NDArray[np.float64]
]
...
@overload
def column_stack[ScalarT: np.generic](
    tup: Sequence[_ArrayLike[ScalarT]],
) -> _MArray[ScalarT]: ...
@overload
...
def hsplit[ScalarT: np.generic](
    ary: _ArrayLike[ScalarT], indices_or_sections: _ShapeLike
) -> list[_MArray[ScalarT]]: ...
@overload
def hsplit(
...
@overload
def diagflat[ScalarT: np.generic](
...
#
def count_masked(
    arr: ArrayLike, axis: SupportsIndex | None = None
) -> NDArray[np.intp]: ...

#
@overload
def masked_all[ScalarT: np.generic](
    shape: _ShapeLike, dtype: _DTypeLike[ScalarT]
) -> _MArray[ScalarT]: ...
@overload
...
#
@overload
def masked_all_like[ScalarT: np.generic](
    arr: _ArrayLike[ScalarT],
) -> _MArray[ScalarT]: ...
@overload
...
#
@overload
def compress_nd[ScalarT: np.generic](
    x: _ArrayLike[ScalarT], axis: _ShapeLike | None = None
) -> NDArray[ScalarT]: ...
@overload
def compress_nd(
    x: ArrayLike, axis: _ShapeLike | None = None
) -> NDArray[Incomplete]: ...

#
@overload
def compress_rowcols[ScalarT: np.generic](
    x: _ArrayLike[ScalarT], axis: int | None = None
) -> _Array2D[ScalarT]: ...
@overload
...
#
def mask_rowcols(
    a: ArrayLike, axis: SupportsIndex | None = None
) -> _MArray[Incomplete]: ...
...
@overload
def union1d(
    ar1: _ArrayLike[_AnyScalarT], ar2: _ArrayLike[_AnyScalarT]
) -> _MArray1D[_AnyScalarT]: ...  # noqa: UP047
@overload
...
#
def in1d(
    ar1: ArrayLike, ar2: ArrayLike, assume_unique: bool = False, invert: bool = False
) -> _MArray1D[np.bool]: ...
...
class MAxisConcatenator(AxisConcatenator):
    ...
    ) -> _MArray[ScalarT]: ...  # pyrefly: ignore[bad-override]
    @overload
    @staticmethod
    def concatenate(
        arrays: SupportsLenAndGetItem[ArrayLike], axis: SupportsIndex | None = 0
    ) -> _MArray[Incomplete]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
...
#
@overload
def flatnotmasked_edges[ScalarT: np.generic](
    a: _ArrayLike[ScalarT],
) -> _Array1D[ScalarT] | None: ...
@overload
def flatnotmasked_edges(a: ArrayLike) -> _Array1D[Incomplete] | None: ...

#
@overload
def notmasked_edges[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], axis: None = None
) -> _Array1D[ScalarT] | None: ...
@overload
...
#
@overload
def notmasked_contiguous(
    a: ArrayLike, axis: None = None
) -> list[slice[int, int, None]]: ...
@overload
...
@overload
def vander[ScalarT: np.number | np.object_](
    x: _ArrayLike[ScalarT], n: int | None = None
) -> _Array2D[ScalarT]: ...
@overload
def vander(
    x: _ArrayLike[np.bool] | list[int], n: int | None = None
) -> _Array2D[np.int_]: ...
@overload
