...
from builtins import type as py_type
...
from typing import (LiteralString, Never, NoReturn, Protocol, Self,
                    ...
                    TypedDict, final, overload, override, type_check_only)
...
from numpy._core.multiarray import (arange, array, asanyarray, asarray,
                                    ...
                                    busdaycalendar, can_cast, concatenate,
                                    copyto, datetime_as_string, datetime_data,
                                    dot, empty, empty_like, flagsobj, flatiter,
                                    frombuffer, fromfile, fromiter, frompyfunc,
                                    fromstring, inner, is_busday, lexsort,
                                    may_share_memory, min_scalar_type, nditer,
...
from numpy._typing import (  # type: ignore[deprecated]; Arrays; DTypes; Shapes; Scalars; `number` precision; NOTE: Do not remove the extended precision bit-types even if seemingly unused;; they're used by the mypy plugin; Character codes; Ufuncs
    ...
    _ArrayLikeUInt_co, _BoolCodes, _BytesCodes, _CharacterCodes, _CharLike_co,
    _CLongDoubleCodes, _Complex64Codes, _Complex128Codes,
    _ComplexFloatingCodes, _DTypeLike, _DTypeLikeVoid, _Float16Codes,
    _Float32Codes, _Float64Codes, _FloatingCodes, _FloatLike_co,
    _GUFunc_Nin2_Nout1, _InexactCodes, _Int8Codes, _Int16Codes, _Int32Codes,
    ...
    _ScalarLike_co, _Shape, _ShapeLike, _SignedIntegerCodes, _StrCodes,
    _StringCodes, _TD64Codes, _TD64Like_co, _UFunc_Nin1_Nout1,
    ...
    _ULongCodes, _ULongLongCodes, _UnsignedIntegerCodes, _VoidCodes,
    _VoidDTypeLike)
from numpy._typing._char_codes import (_DT64Codes_any, _DT64Codes_date,
                                       _DT64Codes_datetime, _DT64Codes_int,
                                       _TD64Codes_any, _TD64Codes_int,
...
from numpy.lib._function_base_impl import (angle, append, asarray_chkfinite,
                                           average, bartlett, blackman, copy,
                                           corrcoef, cov, delete, diff,
                                           digitize, extract, flip, gradient,
                                           hamming, hanning, i0, insert,
                                           interp, iterable, kaiser, median,
                                           meshgrid, percentile, piecewise,
                                           place, quantile, rot90, select,
                                           sinc, sort_complex, trapezoid,
                                           trim_zeros, unwrap, vectorize)
...
from numpy.lib._polynomial_impl import (poly, poly1d, polyadd, polyder,
                                        polydiv, polyfit, polyint, polymul,
                                        polysub, polyval, roots)
...
_NBitT = TypeVar(
    "_NBitT", bound=NBitBase, default=Any
)  # pyright: ignore[reportDeprecated]
_NBitT1 = TypeVar(
    "_NBitT1", bound=NBitBase, default=Any
)  # pyright: ignore[reportDeprecated]
_NBitT2 = TypeVar(
    "_NBitT2", bound=NBitBase, default=_NBitT1
)  # pyright: ignore[reportDeprecated]
...
_NumberItemT_co = TypeVar(
    "_NumberItemT_co", bound=complex, default=Any, covariant=True
)  # either int, float, or complex
_InexactItemT_co = TypeVar(
    "_InexactItemT_co", bound=complex, default=Any, covariant=True
)  # either float or complex
_FlexibleItemT_co = TypeVar(
    "_FlexibleItemT_co",
    bound=bytes | str | tuple[Any, ...],
    default=Any,
    covariant=True,
)
_CharacterItemT_co = TypeVar(
    "_CharacterItemT_co", bound=bytes | str, default=Any, covariant=True
)
...
type _ArrayComplex128_co = NDArray[
    number[_64Bit] | number[_32Bit] | float16 | integer | bool_
]
...
class dtype(Generic[_ScalarT_co], metaclass=_DTypeMeta):
    ...
    @overload
    def __mul__[FlexibleDTypeT: dtype[flexible]](
        self: FlexibleDTypeT, value: SupportsIndex, /
    ) -> FlexibleDTypeT: ...
    @overload
    ...
    @overload
    def __rmul__[FlexibleDTypeT: dtype[flexible]](
        self: FlexibleDTypeT, value: SupportsIndex, /
    ) -> FlexibleDTypeT: ...
    @overload
...
class _ArrayOrScalarCommon:
    ...
    def argmax(
        self, /, axis: SupportsIndex, out: None = None, *, keepdims: py_bool = False
    ) -> Any: ...
    ...
    def round[ArrayT: ndarray](
        self, /, decimals: SupportsIndex, out: ArrayT
    ) -> ArrayT: ...
    @overload
    def round[ArrayT: ndarray](
        self, /, decimals: SupportsIndex = 0, *, out: ArrayT
    ) -> ArrayT: ...
    @overload  # out=None (default)
    def choose(
    ...
    def choose[ArrayT: ndarray](
        self, /, choices: ArrayLike, out: ArrayT, mode: _ModeKind = "raise"
    ) -> ArrayT: ...
    ...
    def clip[ArrayT: ndarray](
        self, /, min: ArrayLike, max: ArrayLike | None, out: ArrayT, **kwargs: Any
    ) -> ArrayT: ...
    @overload
    def clip[ArrayT: ndarray](
        self,
    ...
    @overload
    def clip[ArrayT: ndarray](
        self, /, min: None, max: ArrayLike, out: ArrayT, **kwargs: Any
    ) -> ArrayT: ...
    @overload
    def clip[ArrayT: ndarray](
        self, /, min: None = None, *, max: ArrayLike, out: ArrayT, **kwargs: Any
    ) -> ArrayT: ...
    @overload
    def compress(
        self,
    ...
    def compress[ArrayT: ndarray](
        self, /, condition: _ArrayLikeInt_co, axis: SupportsIndex | None, out: ArrayT
    ) -> ArrayT: ...
    @overload
    def compress[ArrayT: ndarray](
        self,
    ...
    def cumprod[ArrayT: ndarray](
        self, /, axis: SupportsIndex | None, dtype: DTypeLike | None, out: ArrayT
    ) -> ArrayT: ...
    @overload
    def cumprod[ArrayT: ndarray](
        self,
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeT_co, _DTypeT_co]):
    ...
    @overload
    def __array__(
        self, dtype: None = None, /, *, copy: py_bool | None = None
    ) -> ndarray[_ShapeT_co, _DTypeT_co]: ...
    @overload
    def __array__[DTypeT: _dtype](
        self, dtype: DTypeT, /, *, copy: py_bool | None = None
    ) -> ndarray[_ShapeT_co, DTypeT]: ...
    def __array_ufunc__(
        self,
        ufunc: ufunc,
    ...
    ) -> ndarray[_ShapeT_co | _AnyShape, _dtype[void]]: ...
    ...
    @overload
    def tolist[T](
        self: ndarray[tuple[int, int], _dtype[generic[T]]], /
    ) -> list[list[T]]: ...
    @overload
    def tolist[T](
        self: ndarray[tuple[int, int, int], _dtype[generic[T]]], /
    ) -> list[list[list[T]]]: ...
    @overload
    def tolist(self, /) -> Any: ...
    @overload
    ...
    @deprecated("Resizing a NumPy array inplace has been deprecated in NumPy 2.5")
    def resize(
        self, /, *new_shape: SupportsIndex, refcheck: py_bool = True
    ) -> None: ...
    ...
    @overload  # (None)
    def reshape(
        self, shape: None, /, *, order: _OrderACF = "C", copy: py_bool | None = None
    ) -> Self: ...
    ...
    def view(self, /) -> Self: ...
    @overload  # (dtype: T)
    def view[DTypeT: _dtype](
        self, /, dtype: DTypeT | _HasDType[DTypeT]
    ) -> ndarray[_ShapeT_co, DTypeT]: ...
    @overload  # (dtype: dtype[T])
    def view[ScalarT: generic](
        self, /, dtype: _DTypeLike[ScalarT]
    ) -> ndarray[_ShapeT_co, _dtype[ScalarT]]: ...
    @overload  # (type: T)
    ...
    def view[ArrayT: ndarray](
        self, /, dtype: DTypeLike, type: type[ArrayT]
    ) -> ArrayT: ...
    def setfield(
    ...
    def getfield[ScalarT: generic](
        self, /, dtype: _DTypeLike[ScalarT], offset: SupportsIndex = 0
    ) -> NDArray[ScalarT]: ...
    @overload
    def getfield(
    ...
    def __iter__[ScalarT: _ScalarNotObject](
        self: ndarray[tuple[int], _dtype[ScalarT]], /
    ) -> Iterator[ScalarT]: ...
    ...
    @overload
    def __lt__(
        self: _ArrayString, other: _ArrayLikeStr_co | _ArrayLikeString_co, /
    ) -> NDArray[bool_]: ...
    @overload
    ...
    @overload
    def __abs__[ArrayT: NDArray[bool_ | integer | floating | timedelta64 | object_]](
        self: ArrayT, /
    ) -> ArrayT: ...
    def __invert__[ArrayT: NDArray[bool_ | integer | object_]](
        self: ArrayT, /
    ) -> ArrayT: ...
    ...
    def __matmul__[ScalarT: number](
        self: NDArray[ScalarT], other: _ArrayLikeBool_co, /
    ) -> NDArray[ScalarT]: ...
    @overload
    def __matmul__(
    ...
    @overload
    def __matmul__[ScalarT: number](
        self: NDArray[bool_], other: _ArrayLike[ScalarT], /
    ) -> NDArray[ScalarT]: ...
    @overload
    def __matmul__(
    ...
    @overload
    def __divmod__(
        self: NDArray[bool_], rhs: _ArrayLikeBool_co, /
    ...
    ) -> _2Tuple[NDArray[unsignedinteger]]: ...
    @overload
    def __divmod__(
        self: _ArrayInt_co, rhs: _ArrayLikeInt_co, /
    ) -> _2Tuple[NDArray[signedinteger]]: ...
    @overload
    def __divmod__(
    ...
    @overload
    def __rdivmod__(
        self: NDArray[bool_], lhs: _ArrayLikeBool_co, /
    ) -> _2Tuple[NDArray[int8]]: ...
    @overload
    def __rdivmod__[ScalarT: floating | integer](
    ...
    def __pow__[ScalarT: number](
        self: NDArray[ScalarT], other: int | bool_, mod: None = None, /
    ) -> ndarray[_ShapeT_co, _dtype[ScalarT]]: ...
    @overload
    def __pow__[ScalarT: number](
        self: NDArray[ScalarT], other: _ArrayLikeBool_co, mod: None = None, /
    ) -> NDArray[ScalarT]: ...
    @overload
    def __pow__(
        self: NDArray[bool_], other: _ArrayLikeBool_co, mod: None = None, /
    ) -> NDArray[int8]: ...
    @overload
    def __pow__[ScalarT: number](
        self: NDArray[bool_], other: _ArrayLike[ScalarT], mod: None = None, /
    ) -> NDArray[ScalarT]: ...
    @overload
    def __pow__(
    ...
    def __iadd__[ArrayT: NDArray[bool_]](
        self: ArrayT, other: _ArrayLikeBool_co, /
    ) -> ArrayT: ...
    @overload
    def __iadd__[ArrayT: NDArray[complexfloating]](
        self: ArrayT, other: _ArrayLikeComplex_co, /
    ) -> ArrayT: ...
    @overload
    def __iadd__[ArrayT: NDArray[inexact]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __iadd__[ArrayT: NDArray[number]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __iadd__[ArrayT: NDArray[datetime64 | timedelta64]](
        self: ArrayT, other: _ArrayLikeTD64_co, /
    ) -> ArrayT: ...
    @overload
    def __iadd__[ArrayT: NDArray[bytes_]](
        self: ArrayT, other: _ArrayLikeBytes_co, /
    ) -> ArrayT: ...
    @overload
    def __iadd__[ArrayT: _ArrayString](
        self: ArrayT, other: _ArrayLikeStr_co | _ArrayLikeString_co, /
    ) -> ArrayT: ...
    @overload
    def __iadd__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...

    # -=
    @overload  # type: ignore[misc]
    def __isub__[ArrayT: NDArray[complexfloating]](
        self: ArrayT, other: _ArrayLikeComplex_co, /
    ) -> ArrayT: ...
    @overload
    def __isub__[ArrayT: NDArray[inexact]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __isub__[ArrayT: NDArray[number]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __isub__[ArrayT: NDArray[datetime64 | timedelta64]](
        self: ArrayT, other: _ArrayLikeTD64_co, /
    ) -> ArrayT: ...
    @overload
    def __isub__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...

    # *=
    @overload  # type: ignore[misc]
    def __imul__[ArrayT: NDArray[bool_]](
        self: ArrayT, other: _ArrayLikeBool_co, /
    ) -> ArrayT: ...
    @overload
    def __imul__[ArrayT: NDArray[complexfloating]](
        self: ArrayT, other: _ArrayLikeComplex_co, /
    ) -> ArrayT: ...
    @overload
    def __imul__[ArrayT: NDArray[inexact | timedelta64]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __imul__[ArrayT: NDArray[number | character]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __imul__[ArrayT: _ArrayString](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __imul__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...

    # @=
    @overload  # type: ignore[misc]
    def __imatmul__[ArrayT: NDArray[bool_]](
        self: ArrayT, other: _ArrayLikeBool_co, /
    ) -> ArrayT: ...
    @overload
    def __imatmul__[ArrayT: NDArray[complexfloating]](
        self: ArrayT, other: _ArrayLikeComplex_co, /
    ) -> ArrayT: ...
    @overload
    def __imatmul__[ArrayT: NDArray[inexact]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __imatmul__[ArrayT: NDArray[number]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __imatmul__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...

    # **=
    @overload  # type: ignore[misc]
    def __ipow__[ArrayT: NDArray[complexfloating]](
        self: ArrayT, other: _ArrayLikeComplex_co, /
    ) -> ArrayT: ...
    @overload
    def __ipow__[ArrayT: NDArray[inexact]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __ipow__[ArrayT: NDArray[number]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __ipow__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...

    # /=
    @overload  # type: ignore[misc]
    def __itruediv__[ArrayT: NDArray[complexfloating]](
        self: ArrayT, other: _ArrayLikeComplex_co, /
    ) -> ArrayT: ...
    @overload
    def __itruediv__[ArrayT: NDArray[inexact | timedelta64]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __itruediv__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...
    ...
    @overload  # type: ignore[misc]
    def __ifloordiv__[ArrayT: NDArray[integer]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __ifloordiv__[ArrayT: NDArray[floating | timedelta64]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __ifloordiv__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...
    ...
    @overload  # type: ignore[misc]
    def __imod__[ArrayT: NDArray[integer]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __imod__[ArrayT: NDArray[floating]](
        self: ArrayT, other: _ArrayLikeFloat_co, /
    ) -> ArrayT: ...
    @overload
    def __imod__[ArrayT: NDArray[timedelta64]](
        self: ArrayT, other: _ArrayLike[timedelta64], /
    ) -> ArrayT: ...
    @overload
    def __imod__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...
    ...
    @overload  # type: ignore[misc]
    def __ilshift__[ArrayT: NDArray[integer]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __ilshift__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...
    ...
    @overload  # type: ignore[misc]
    def __irshift__[ArrayT: NDArray[integer]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __irshift__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...
    ...
    @overload  # type: ignore[misc]
    def __iand__[ArrayT: NDArray[bool_]](
        self: ArrayT, other: _ArrayLikeBool_co, /
    ) -> ArrayT: ...
    @overload
    def __iand__[ArrayT: NDArray[integer]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __iand__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...
    ...
    @overload  # type: ignore[misc]
    def __ixor__[ArrayT: NDArray[bool_]](
        self: ArrayT, other: _ArrayLikeBool_co, /
    ) -> ArrayT: ...
    @overload
    def __ixor__[ArrayT: NDArray[integer]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
    def __ixor__[ArrayT: NDArray[object_]](
        self: ArrayT, other: object, /
    ) -> ArrayT: ...
    ...
    @overload  # type: ignore[misc]
    def __ior__[ArrayT: NDArray[bool_]](
        self: ArrayT, other: _ArrayLikeBool_co, /
    ) -> ArrayT: ...
    @overload
    def __ior__[ArrayT: NDArray[integer]](
        self: ArrayT, other: _ArrayLikeInt_co, /
    ) -> ArrayT: ...
    @overload
...
class generic(_ArrayOrScalarCommon, Generic[_ItemT_co]):
    ...
    @overload
    def view[ScalarT: generic](
        self, /, dtype: _DTypeLike[ScalarT], type: type[ndarray] = ...
    ) -> ScalarT: ...
    @overload
...
class bool(generic[_BoolItemT_co], Generic[_BoolItemT_co]):
    ...
    @overload
    def __pow__[ScalarT: number](
        self, other: ScalarT, mod: None = None, /
    ) -> ScalarT: ...
    @overload
    ...
    @overload
    def __divmod__[ScalarT: integer | floating](
        self, other: ScalarT, /
    ) -> _2Tuple[ScalarT]: ...
    @overload
    ...
    @overload
    def __rdivmod__[ScalarT: integer | floating](
        self, other: ScalarT, /
    ) -> _2Tuple[ScalarT]: ...
    @overload
    ...
    @overload
    def __and__(
        self: bool_[L[False]], other: py_bool | bool_, /
    ) -> bool_[L[False]]: ...
    @overload
    ...
    @overload
    def __xor__[ItemT: py_bool](
        self: bool_[L[False]], other: ItemT | bool_[ItemT], /
    ) -> bool_[ItemT]: ...
    @overload
    def __xor__(
        self: bool_[L[True]], other: L[True] | bool_[L[True]], /
    ) -> bool_[L[False]]: ...
    @overload
...
class float64(floating[_64Bit], float):  # type: ignore[misc]
    ...
    @overload
    def __add__[NBitT: NBitBase](
        self, other: complexfloating[NBitT], /
    ...
    @overload
    def __floordiv__[NBitT: NBitBase](
        self, other: complexfloating[NBitT], /
    ) -> complexfloating[NBitT | _64Bit]: ...
    @overload
    ...
    @overload
    def __rfloordiv__[NBitT: NBitBase](
        self, other: complexfloating[NBitT], /
    ) -> complexfloating[NBitT | _64Bit]: ...
    @overload
...
class complexfloating(inexact[_NBitT1, complex], Generic[_NBitT1, _NBitT2]):
    ...
    ) -> complexfloating[_NBitT1, _NBitT2]: ...
    @overload
    def __radd__(
        self, other: complex, /
    ) -> complexfloating[_NBitT1, _NBitT2] | complex128: ...
...
class timedelta64(_IntegralMixin, generic[_TD64ItemT_co], Generic[_TD64ItemT_co]):
    ...
    @overload
    def __new__(
        cls, value: _NaTValue | None, format: _TimeUnitSpec[_TD64Unit], /
    ) -> timedelta64[None]: ...
    @overload
    @deprecated(
        "Using 'generic' unit for NumPy timedelta is deprecated, and will raise an error in the future. "
    ...
    def __new__(
        cls, value: dt.timedelta | _IntLike_co, /
    ...
    @overload
    def __new__(
        cls, value: _ConvertibleToTD64, format: _TimeUnitSpec[_TD64Unit], /
    ) -> timedelta64: ...
    ...
    @overload
    def __add__(
        self: timedelta64[Never], x: timedelta64[int | dt.timedelta], /
    ) -> timedelta64: ...
    @overload
    @overload
    ...
    @overload
    def __add__(
        self: timedelta64[int | dt.timedelta], x: timedelta64[Never], /
    ) -> timedelta64: ...
    @overload
    ...
    @overload
    @deprecated(
        "Adding bare integers to NumPy timedelta is deprecated, and will raise an error in the future."
    )
    def __add__[AnyItemT: (dt.timedelta, int, None, _TD64Item)](
    ...
    @overload
    def __sub__(
        self: timedelta64[Never], b: timedelta64[int | dt.timedelta], /
    ) -> timedelta64: ...
    @overload
    def __sub__(self: timedelta64[None], b: timedelta64, /) -> timedelta64[None]: ...
    @overload
    def __sub__(
        self: timedelta64[int | dt.timedelta], b: timedelta64[Never], /
    ) -> timedelta64: ...
    @overload
    ...
    @overload
    @deprecated(
        "Subtracting bare integers from NumPy timedelta is deprecated, and will raise an error in the future."
    )
    def __sub__[AnyItemT: (dt.timedelta, int, None, _TD64Item)](
    ...
    @overload
    def __rsub__(
        self: timedelta64[Never], a: timedelta64[int | dt.timedelta], /
    ) -> timedelta64: ...
    @overload
    def __rsub__(self: timedelta64[None], a: timedelta64, /) -> timedelta64[None]: ...
    @overload
    def __rsub__[AnyDateT: (dt.datetime, dt.date)](
        self: timedelta64[dt.timedelta], a: AnyDateT, /
    ) -> AnyDateT: ...
    @overload
    ...
    @overload
    @deprecated(
        "Subtracting NumPy timedelta from bare integers is deprecated, and will raise an error in the future."
    )
    def __rsub__[AnyItemT: (dt.timedelta, int, None, _TD64Item)](
    ...
    @overload
    def __mod__(
        self: timedelta64[Never], x: timedelta64[dt.timedelta], /
    ) -> timedelta64: ...
    @overload
    def __mod__(
        self: timedelta64[int | dt.timedelta], x: timedelta64[Never], /
    ...
    @overload
    def __mod__(
        self: timedelta64[dt.timedelta], x: timedelta64[int], /
    ) -> timedelta64[int | None]: ...
    @overload
    def __mod__(
    ...
    @overload
    def __truediv__(
        self: timedelta64[Never], b: float | floating | integer, /
    ) -> timedelta64: ...
    @overload
    ...
    @overload
    @deprecated(
        "Comparing NumPy timedelta with bare integers is deprecated, and will raise an error in the future."
    )
    ...
    @overload
    def __lt__(
        self, other: _ArrayLike[timedelta64] | _NestedSequence[_SupportsGT], /
    ) -> NDArray[bool_]: ...
    @overload
    def __lt__(self, other: _SupportsGT, /) -> bool_: ...
    @overload
    ...
    @overload
    def __le__(
        self, other: _ArrayLike[timedelta64] | _NestedSequence[_SupportsGE], /
    ) -> NDArray[bool_]: ...
    @overload
    def __le__(self, other: _SupportsGE, /) -> bool_: ...
    @overload
    ...
    @overload
    def __gt__(
        self, other: _ArrayLike[timedelta64] | _NestedSequence[_SupportsLT], /
    ) -> NDArray[bool_]: ...
    @overload
    def __gt__(self, other: _SupportsLT, /) -> bool_: ...
    @overload
    ...
    @overload
    def __ge__(
        self, other: _ArrayLike[timedelta64] | _NestedSequence[_SupportsLE], /
    ) -> NDArray[bool_]: ...
    @overload
    def __ge__(self, other: _SupportsLE, /) -> bool_: ...
...
class datetime64(_RealMixin, generic[_DT64ItemT_co], Generic[_DT64ItemT_co]):
    ...
    @overload
    def __new__[AnyItemT: (dt.datetime, dt.date, None)](
        cls, value: AnyItemT, /
    ) -> datetime64[AnyItemT]: ...
    @overload
    def __new__(
    ...
    def __new__(
        cls,
        value: bytes | str | dt.date | None,
        format: _TimeUnitSpec[_TD64Unit] = ...,
        /,
    ) -> Self: ...
    ...
    @overload
    def __add__(
        self: datetime64[int | dt.datetime], x: timedelta64[Never], /
    ) -> datetime64: ...
    @overload
    def __add__(
