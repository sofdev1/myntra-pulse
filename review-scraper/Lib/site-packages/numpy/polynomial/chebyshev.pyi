...
from ._polytypes import (_Array1, _Array2, _CoefSeries, _FuncBinOp,
                         ...
                         _FuncVal3D, _FuncValND, _FuncVander, _FuncVander2D,
                         _FuncVander3D, _FuncWeight, _Series,
                         _SeriesLikeCoef_co)
...
def _cseries_to_zseries[ScalarT: np.number | np.object_](
    c: npt.NDArray[ScalarT],
) -> _Series[ScalarT]: ...
def _zseries_to_cseries[ScalarT: np.number | np.object_](
    zs: npt.NDArray[ScalarT],
) -> _Series[ScalarT]: ...
def _zseries_mul[ScalarT: np.number | np.object_](
    z1: npt.NDArray[ScalarT], z2: npt.NDArray[ScalarT]
) -> _Series[ScalarT]: ...
def _zseries_div[ScalarT: np.number | np.object_](
    z1: npt.NDArray[ScalarT], z2: npt.NDArray[ScalarT]
) -> _Series[ScalarT]: ...
def _zseries_der[ScalarT: np.number | np.object_](
    zs: npt.NDArray[ScalarT],
) -> _Series[ScalarT]: ...
def _zseries_int[ScalarT: np.number | np.object_](
    zs: npt.NDArray[ScalarT],
) -> _Series[ScalarT]: ...
...
class Chebyshev(ABCPolyBase[L["T"]]):
    basis_name: ClassVar[L["T"]] = (
        "T"  # pyright: ignore[reportIncompatibleMethodOverride] # pyrefly: ignore[bad-override]
    )
