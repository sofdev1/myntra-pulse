...
from typing import (Any, Literal, NoReturn, Protocol, Self, SupportsIndex,
                    SupportsInt, overload, type_check_only)

import numpy as np
import numpy.typing as npt
from numpy._typing import (_ArrayLikeComplex_co, _ArrayLikeFloat_co,
                           _ArrayLikeNumber_co, _ComplexLike_co, _FloatLike_co,
...
type _SeriesLikeInt_co = _SupportsArray[np.dtype[np.integer | np.bool]] | Sequence[
    _IntLike_co
]
type _SeriesLikeFloat_co = _SupportsArray[
    np.dtype[np.floating | np.integer | np.bool]
] | Sequence[_FloatLike_co]
type _SeriesLikeComplex_co = _SupportsArray[np.dtype[np.number | np.bool]] | Sequence[
    _ComplexLike_co
]
type _SeriesLikeObject_co = _SupportsArray[np.dtype[np.object_]] | Sequence[
    _CoefObjectLike_co
]
type _SeriesLikeCoef_co = _SupportsArray[np.dtype[_PolyScalar]] | Sequence[_CoefLike_co]

type _ArrayLikeCoefObject_co = _CoefObjectLike_co | _SeriesLikeObject_co | _NestedSequence[
    _SeriesLikeObject_co
]
type _ArrayLikeCoef_co = npt.NDArray[
    _PolyScalar
] | _ArrayLikeNumber_co | _ArrayLikeCoefObject_co
...
class _FuncLine(Protocol):
    @overload
    def __call__[ScalarT: _PolyScalar](
        self, /, off: ScalarT, scl: ScalarT
    ) -> _Line[ScalarT]: ...
    @overload
