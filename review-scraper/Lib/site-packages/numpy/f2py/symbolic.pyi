...
class Expr(Generic[_OpT_co, _DataT_co]):
    ...
    #
    @overload
    def __getitem__[ExprT: Expr](
        self, index: ExprT | tuple[ExprT], /
    ) -> Expr[L[Op.INDEXING], tuple[Self, ExprT]]: ...
    @overload
    def __getitem__(
    ...
    @overload
    def traverse[**Tss](
        self, /, visit: Callable[Tss, None], *args: Tss.args, **kwargs: Tss.kwargs
    ) -> Expr: ...
    @overload
    def traverse[**Tss, ExprT: Expr](
        self, /, visit: Callable[Tss, ExprT], *args: Tss.args, **kwargs: Tss.kwargs
    ) -> ExprT: ...
...
class _Pair(Generic[_LeftT_co, _RightT_co]):
    ...
    #
    @overload
    def substitute[ExprT: Expr](
        self: _Pair[ExprT, ExprT], /, symbols_map: Mapping[Expr, Expr]
    ) -> _Pair[Expr, Expr]: ...
    @overload
    def substitute[ExprT: Expr](
        self: _Pair[ExprT, object], /, symbols_map: Mapping[Expr, Expr]
    ) -> _Pair[Expr, Any]: ...
    @overload
    def substitute[ExprT: Expr](
        self: _Pair[object, ExprT], /, symbols_map: Mapping[Expr, Expr]
    ) -> _Pair[Any, Expr]: ...
    @overload
