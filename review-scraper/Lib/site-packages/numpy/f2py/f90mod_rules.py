...
def buildhooks(pymod):
    ...
    for m in findf90modules(pymod):
        ...
        for n in onlyvars:
            ...
            cadd(
                f'\t{{"{undo_rmbadname1(n)}",{rank},{{{{{dms}}}}},{at}, ' f"{elsize}}},"
            )
        ...
        if hasbody(m):
            ...
            for b in m["body"]:
                ...
                if not isroutine(b):
                    outmess(
                        "f90mod_rules.buildhooks:" f" skipping {b['block']} {b_name}\n"
                    )
                    continue
        ...
        ihooks[0] = (
            f"static void f2py_setup_{m_name}({sargs_str}) "
