...
from .auxfuncs import (applyrules, debugcapi, dictappend, errmess, gentitle,
                       ...
                       isintent_inplace, isintent_nothide, isintent_out,
                       isintent_overwrite, islogical, islong_complex,
                       islong_double, islong_doublefunction, islong_long,
                       islong_longfunction, ismoduleroutine, isoptional,
                       isrequired, isscalar, issigned_long_longarray, isstring,
                       isstringarray, isstringfunction, issubroutine,
                       issubroutine_wrap, isthreadsafe, isunsigned,
                       isunsigned_char, isunsigned_chararray,
                       isunsigned_long_long, isunsigned_long_longarray,
                       isunsigned_short, isunsigned_shortarray, l_and, l_not,
                       l_or, outmess, replace, requiresf90wrapper, stripcomma)
...
""",
    ...
    if (f2py_success) {""",
        ...
        "closepyobjfrom": {
            isintent_inplace: "    } /*if (f2py_success) of #varname# pyobjfrom*/"
        },
...
def buildapi(rout):
    ...
    if ismoduleroutine(rout):
        ...
        name = rout["name"]
        outmess(
            "            Constructing wrapper function " f'"{module_name}.{name}"...\n'
        )
    else:
