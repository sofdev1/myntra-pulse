...
from typing import NoReturn, Self, SupportsIndex, overload, type_check_only
...
type _ExceptionSpec[ExceptionT: BaseException] = type[ExceptionT] | tuple[
    type[ExceptionT], ...
]
...
@overload
def assert_no_warnings[**Tss, ReturnT](
    func: Callable[Tss, ReturnT], /, *args: Tss.args, **kwargs: Tss.kwargs
) -> ReturnT: ...
...
@overload
def assert_no_gc_cycles[**Tss](
    func: Callable[Tss, Any], /, *args: Tss.args, **kwargs: Tss.kwargs
) -> None: ...
