...
from typing import (Any, Literal, LiteralString, Never, NoReturn, Protocol,
                    SupportsIndex, TypedDict, Unpack, overload, override,
                    type_check_only)
...
from ._array_like import (ArrayLike, NDArray, _ArrayLikeBool_co,
                          _ArrayLikeInt_co)
...
class _UFunc_Nin1_Nout1[NameT: LiteralString, NTypesT: int, IdentT](ufunc):  # type: ignore[misc]
    ...
    def __qualname__(
        self,
    ) -> NameT: ...  # pyright: ignore[reportIncompatibleVariableOverride]
    @property
