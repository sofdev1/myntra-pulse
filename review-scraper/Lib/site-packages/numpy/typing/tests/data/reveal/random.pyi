...
assert_type(
    def_gen.hypergeometric(I_arr_like_20, 20, I_arr_10), npt.NDArray[np.int64] | Any
)
...
assert_type(
    def_gen.integers(I_bool_low, I_bool_high_open, dtype=bool), npt.NDArray[Any] | Any
)
...
assert_type(
    def_gen.integers(I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool] | Any
)
assert_type(
...
assert_type(
    ...
    npt.NDArray[np.uint8] | Any,
)
assert_type(
    def_gen.integers(I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8] | Any
)
assert_type(
...
assert_type(
    ...
    npt.NDArray[np.uint16] | Any,
)
assert_type(
    def_gen.integers(I_u2_high_open, dtype=np.uint16), npt.NDArray[np.uint16] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u2_high_open, dtype=np.uint16), npt.NDArray[np.uint16] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u4_high_open, dtype=np.int_), npt.NDArray[np.int_] | Any
)
assert_type(
...
assert_type(
    ...
    npt.NDArray[np.uint32] | Any,
)
assert_type(
    def_gen.integers(I_u4_high_open, dtype=np.uint32), npt.NDArray[np.uint32] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u4_high_open, dtype=np.uint32), npt.NDArray[np.uint32] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u4_high_open, dtype=np.uint), npt.NDArray[np.uint] | Any
)
assert_type(
...
assert_type(
    ...
    npt.NDArray[np.uint64] | Any,
)
assert_type(
    def_gen.integers(I_u8_high_open, dtype=np.uint64), npt.NDArray[np.uint64] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(0, I_u8_high_open, dtype=np.uint64), npt.NDArray[np.uint64] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(-128, I_i1_high_open, dtype=np.int8), npt.NDArray[np.int8] | Any
)
assert_type(
...
assert_type(
    ...
    npt.NDArray[np.int16] | Any,
)
assert_type(
    def_gen.integers(I_i2_high_open, dtype=np.int16), npt.NDArray[np.int16] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(I_i4_high_open, dtype=np.int32), npt.NDArray[np.int32] | Any
)
assert_type(
...
assert_type(
    def_gen.integers(I_i8_high_open, dtype=np.int64), npt.NDArray[np.int64] | Any
)
assert_type(
...
assert_type(
    def_gen.choice(
        str_list, 3, replace=False, p=np.array([1 / 8, 1 / 8, 1 / 2, 1 / 4])
    ),
    npt.NDArray[Any],
)
...
assert_type(
    random_st.vonmises(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.wald(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.uniform(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.beta(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.gamma(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.gumbel(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.laplace(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.logistic(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.lognormal(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.noncentral_chisquare(D_arr_0p5, 0.5), npt.NDArray[np.float64] | Any
)
assert_type(
    random_st.noncentral_chisquare(0.5, D_arr_0p5), npt.NDArray[np.float64] | Any
)
assert_type(
...
assert_type(
    random_st.noncentral_chisquare(D_arr_like_0p5, 0.5), npt.NDArray[np.float64] | Any
)
assert_type(
    random_st.noncentral_chisquare(0.5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
assert_type(
    random_st.noncentral_chisquare(D_arr_0p5, D_arr_0p5), npt.NDArray[np.float64] | Any
)
assert_type(
...
assert_type(
    random_st.normal(D_arr_like_0p5, D_arr_like_0p5), npt.NDArray[np.float64] | Any
)
...
assert_type(
    random_st.triangular(D_arr_like_0p1, 0.5, D_arr_0p9), npt.NDArray[np.float64] | Any
)
assert_type(
    random_st.triangular(0.5, D_arr_like_0p5, 0.9), npt.NDArray[np.float64] | Any
)
assert_type(
    random_st.triangular(D_arr_0p1, D_arr_0p5, 0.9), npt.NDArray[np.float64] | Any
)
assert_type(
...
assert_type(
    random_st.noncentral_f(0.5, D_arr_like_0p5, 0.9), npt.NDArray[np.float64] | Any
)
assert_type(
    random_st.noncentral_f(D_arr_0p1, D_arr_0p5, 0.9), npt.NDArray[np.float64] | Any
)
assert_type(
...
assert_type(
    random_st.binomial(I_arr_like_10, D_arr_like_0p5), npt.NDArray[np.long] | Any
)
...
assert_type(
    random_st.negative_binomial(I_arr_10, D_arr_0p5), npt.NDArray[np.long] | Any
)
assert_type(
    random_st.negative_binomial(I_arr_like_10, D_arr_like_0p5),
    npt.NDArray[np.long] | Any,
)
assert_type(
    random_st.negative_binomial(I_arr_like_10, D_arr_like_0p5),
    npt.NDArray[np.long] | Any,
...
assert_type(
    random_st.hypergeometric(I_arr_like_20, 20, I_arr_10), npt.NDArray[np.long] | Any
)
assert_type(random_st.hypergeometric(20, I_arr_like_20, 10), npt.NDArray[np.long] | Any)
assert_type(
    random_st.hypergeometric(I_arr_20, I_arr_20, 10), npt.NDArray[np.long] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_bool_high_open, dtype=bool), npt.NDArray[np.bool] | Any
)

assert_type(random_st.randint(2, dtype=np.bool), np.bool)
assert_type(random_st.randint(0, 2, dtype=np.bool), np.bool)
assert_type(
    random_st.randint(I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_bool_high_open, dtype=np.bool), npt.NDArray[np.bool] | Any
)
...
assert_type(
    random_st.randint(I_u1_low, I_u1_high_open, dtype="u1"), npt.NDArray[np.uint8] | Any
)
assert_type(
    random_st.randint(0, I_u1_high_open, dtype="u1"), npt.NDArray[np.uint8] | Any
)

assert_type(random_st.randint(256, dtype="uint8"), np.uint8)
assert_type(random_st.randint(0, 256, dtype="uint8"), np.uint8)
assert_type(
    random_st.randint(I_u1_high_open, dtype="uint8"), npt.NDArray[np.uint8] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u1_high_open, dtype="uint8"), npt.NDArray[np.uint8] | Any
)

assert_type(random_st.randint(256, dtype=np.uint8), np.uint8)
assert_type(random_st.randint(0, 256, dtype=np.uint8), np.uint8)
assert_type(
    random_st.randint(I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u1_high_open, dtype=np.uint8), npt.NDArray[np.uint8] | Any
)
...
assert_type(
    random_st.randint(0, I_u2_high_open, dtype="u2"), npt.NDArray[np.uint16] | Any
)

assert_type(random_st.randint(65536, dtype="uint16"), np.uint16)
assert_type(random_st.randint(0, 65536, dtype="uint16"), np.uint16)
assert_type(
    random_st.randint(I_u2_high_open, dtype="uint16"), npt.NDArray[np.uint16] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u2_high_open, dtype="uint16"), npt.NDArray[np.uint16] | Any
)
...
assert_type(
    random_st.randint(I_u2_high_open, dtype=np.uint16), npt.NDArray[np.uint16] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u2_high_open, dtype=np.uint16), npt.NDArray[np.uint16] | Any
)
...
assert_type(
    random_st.randint(0, I_u4_high_open, dtype="u4"), npt.NDArray[np.uint32] | Any
)
...
assert_type(
    random_st.randint(I_u4_high_open, dtype="uint32"), npt.NDArray[np.uint32] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u4_high_open, dtype="uint32"), npt.NDArray[np.uint32] | Any
)
...
assert_type(
    random_st.randint(I_u4_high_open, dtype=np.uint32), npt.NDArray[np.uint32] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u4_high_open, dtype=np.uint32), npt.NDArray[np.uint32] | Any
)
...
assert_type(
    random_st.randint(I_u4_high_open, dtype=np.uint), npt.NDArray[np.uint] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u4_high_open, dtype=np.uint), npt.NDArray[np.uint] | Any
)
...
assert_type(
    random_st.randint(0, I_u8_high_open, dtype="u8"), npt.NDArray[np.uint64] | Any
)
...
assert_type(
    random_st.randint(I_u8_high_open, dtype="uint64"), npt.NDArray[np.uint64] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u8_high_open, dtype="uint64"), npt.NDArray[np.uint64] | Any
)
...
assert_type(
    random_st.randint(I_u8_high_open, dtype=np.uint64), npt.NDArray[np.uint64] | Any
)
assert_type(
...
assert_type(
    random_st.randint(0, I_u8_high_open, dtype=np.uint64), npt.NDArray[np.uint64] | Any
)
...
assert_type(
    random_st.randint(I_i1_low, I_i1_high_open, dtype="i1"), npt.NDArray[np.int8] | Any
)
assert_type(
    random_st.randint(-128, I_i1_high_open, dtype="i1"), npt.NDArray[np.int8] | Any
)
...
assert_type(
    random_st.randint(-128, I_i1_high_open, dtype="int8"), npt.NDArray[np.int8] | Any
)

assert_type(random_st.randint(128, dtype=np.int8), np.int8)
assert_type(random_st.randint(-128, 128, dtype=np.int8), np.int8)
assert_type(
    random_st.randint(I_i1_high_open, dtype=np.int8), npt.NDArray[np.int8] | Any
)
assert_type(
...
assert_type(
    random_st.randint(-128, I_i1_high_open, dtype=np.int8), npt.NDArray[np.int8] | Any
)
...
assert_type(
    random_st.randint(I_i2_low, I_i2_high_open, dtype="i2"), npt.NDArray[np.int16] | Any
)
assert_type(
    random_st.randint(-32768, I_i2_high_open, dtype="i2"), npt.NDArray[np.int16] | Any
)

assert_type(random_st.randint(32768, dtype="int16"), np.int16)
assert_type(random_st.randint(-32768, 32768, dtype="int16"), np.int16)
assert_type(
    random_st.randint(I_i2_high_open, dtype="int16"), npt.NDArray[np.int16] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i2_high_open, dtype=np.int16), npt.NDArray[np.int16] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_low, I_i4_high_open, dtype="i4"), npt.NDArray[np.int32] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_high_open, dtype="int32"), npt.NDArray[np.int32] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_high_open, dtype=np.int32), npt.NDArray[np.int32] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i4_high_open, dtype=np.int_), npt.NDArray[np.int_] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i8_low, I_i8_high_open, dtype="i8"), npt.NDArray[np.int64] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i8_high_open, dtype="int64"), npt.NDArray[np.int64] | Any
)
assert_type(
...
assert_type(
    random_st.randint(I_i8_high_open, dtype=np.int64), npt.NDArray[np.int64] | Any
)
assert_type(
