...
assert_type(
    AR_f8_3d.all(keepdims=True), np.ndarray[tuple[int, int, int], np.dtype[np.bool]]
)
...
assert_type(
    AR_f8_3d.any(keepdims=True), np.ndarray[tuple[int, int, int], np.dtype[np.bool]]
)
...
assert_type(
    AR_f8_2d.argmax(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.intp]]
)
assert_type(
    AR_f8_3d.argmax(keepdims=True), np.ndarray[tuple[int, int, int], np.dtype[np.intp]]
)
...
assert_type(
    AR_f8_2d.argmin(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.intp]]
)
assert_type(
    AR_f8_3d.argmin(keepdims=True), np.ndarray[tuple[int, int, int], np.dtype[np.intp]]
)
...
assert_type(
    AR_f8.cumprod(dtype=np.float32), np.ndarray[tuple[int], np.dtype[np.float32]]
)
...
assert_type(
    AR_f8_2d.cumprod(dtype=np.float32), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    AR_f8_2d.cumprod(dtype=np.float32, axis=0),
...
assert_type(
    AR_f8.cumsum(dtype=np.float32), np.ndarray[tuple[int], np.dtype[np.float32]]
)
...
assert_type(
    AR_f8_2d.cumsum(dtype=np.float32), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    AR_f8_2d.cumsum(dtype=np.float32, axis=0),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
...
assert_type(
    AR_f8.prod(dtype=np.float32, axis=0, keepdims=True), npt.NDArray[np.float32]
)
assert_type(AR_f8.prod(out=B), SubClass)
assert_type(AR_f8_2d.prod(), np.float64)
assert_type(
    AR_f8_2d.prod(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(AR_f8_2d.prod(axis=0), npt.NDArray[np.float64])
assert_type(
    AR_f8_2d.prod(axis=0, keepdims=True),
...
assert_type(
    AR_f8_2d.prod(dtype=np.float32, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
assert_type(
    AR_f8_2d.prod(dtype=np.float32, axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
...
assert_type(
    AR_f8_2d.sum(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(AR_f8_2d.sum(axis=0), npt.NDArray[np.float64])
assert_type(
    AR_f8_2d.sum(axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    AR_f8_2d.sum(dtype=np.float32, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
assert_type(
    AR_f8_2d.sum(dtype=np.float32, axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
...
assert_type(
    AR_f8.mean(dtype=np.float32, axis=0, keepdims=True), npt.NDArray[np.float32]
)
assert_type(AR_f8.mean(out=B), SubClass)
assert_type(AR_f8_2d.mean(), np.float64)
assert_type(
    AR_f8_2d.mean(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(AR_f8_2d.mean(axis=0), npt.NDArray[np.float64])
assert_type(
    AR_f8_2d.mean(axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    AR_f8_2d.mean(dtype=np.float32, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
assert_type(
    AR_f8_2d.mean(dtype=np.float32, axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
...
assert_type(
    AR_f8_2d.std(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(AR_f8_2d.std(axis=0), npt.NDArray[np.float64])
assert_type(
    AR_f8_2d.std(axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    AR_f8_2d.std(dtype=np.float32, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
assert_type(
    AR_f8_2d.std(dtype=np.float32, axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
...
assert_type(
    AR_f8_2d.var(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(AR_f8_2d.var(axis=0), npt.NDArray[np.float64])
assert_type(
    AR_f8_2d.var(axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    AR_f8_2d.var(dtype=np.float32, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
assert_type(
    AR_f8_2d.var(dtype=np.float32, axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float32]],
)
...
assert_type(
    AR_f8_2d.max(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(AR_f8_2d.max(axis=0), npt.NDArray[np.float64])
assert_type(
    AR_f8_2d.max(axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    AR_f8_2d.min(keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(AR_f8_2d.min(axis=0), npt.NDArray[np.float64])
assert_type(
    AR_f8_2d.min(axis=0, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
