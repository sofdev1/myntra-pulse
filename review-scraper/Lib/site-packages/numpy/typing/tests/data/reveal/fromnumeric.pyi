...
assert_type(
    np.partition(AR_f4, 0, axis=None), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(np.partition(AR_f4_1d, 0), np.ndarray[tuple[int], np.dtype[np.float32]])
assert_type(
    np.partition(AR_f4_2d, 0), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
assert_type(
    np.partition(AR_f4_3d, 0), np.ndarray[tuple[int, int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.argpartition(f4, 0, axis=None), np.ndarray[tuple[int], np.dtype[np.intp]]
)
assert_type(np.argpartition(f, 0, axis=None), np.ndarray[tuple[int], np.dtype[np.intp]])
assert_type(
    np.argpartition(AR_b, 0, axis=None), np.ndarray[tuple[int], np.dtype[np.intp]]
)
assert_type(
    np.argpartition(AR_f4, 0, axis=None), np.ndarray[tuple[int], np.dtype[np.intp]]
)
...
assert_type(
    np.argmax(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.intp]]
)
assert_type(
    np.argmax(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.intp]]
)
assert_type(
    np.argmax(AR_f4_3d, keepdims=True),
...
assert_type(
    np.argmin(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.intp]]
)
assert_type(
    np.argmin(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.intp]]
)
assert_type(
    np.argmin(AR_f4_3d, keepdims=True),
    np.ndarray[tuple[int, int, int], np.dtype[np.intp]],
)
...
assert_type(
    np.all(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.bool]]
)
assert_type(
    np.all(AR_f4_3d, keepdims=True), np.ndarray[tuple[int, int, int], np.dtype[np.bool]]
)
...
assert_type(
    np.any(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.bool]]
)
assert_type(
    np.any(AR_f4_3d, keepdims=True), np.ndarray[tuple[int, int, int], np.dtype[np.bool]]
)
...
assert_type(
    np.cumsum(f, dtype=np.float64), np.ndarray[tuple[int], np.dtype[np.float64]]
)
...
assert_type(
    np.cumulative_sum(f, dtype=np.float64), np.ndarray[tuple[int], np.dtype[np.float64]]
)
...
assert_type(
    np.ptp(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.ptp(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.amax(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.amax(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.amin(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.amin(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.cumprod(f, dtype=np.float64), np.ndarray[tuple[int], np.dtype[np.float64]]
)
...
assert_type(
    np.cumulative_prod(f, dtype=np.float64),
...
assert_type(
    np.prod(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.prod(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.prod(AR_f4_1d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int], np.dtype[np.float64]],
)
assert_type(
    np.prod(AR_f4_2d, dtype=np.float64, keepdims=True),
...
assert_type(
    np.sum(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.sum(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.sum(AR_f4_1d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int], np.dtype[np.float64]],
)
assert_type(
    np.sum(AR_f4_2d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    np.mean(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.mean(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.mean(AR_f4_1d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int], np.dtype[np.float64]],
)
assert_type(
    np.mean(AR_f4_2d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    np.std(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.std(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.std(AR_f4_1d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int], np.dtype[np.float64]],
)
assert_type(
    np.std(AR_f4_2d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
...
assert_type(
    np.var(AR_f4_1d, keepdims=True), np.ndarray[tuple[int], np.dtype[np.float32]]
)
assert_type(
    np.var(AR_f4_2d, keepdims=True), np.ndarray[tuple[int, int], np.dtype[np.float32]]
)
...
assert_type(
    np.var(AR_f4_1d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int], np.dtype[np.float64]],
)
assert_type(
    np.var(AR_f4_2d, dtype=np.float64, keepdims=True),
    np.ndarray[tuple[int, int], np.dtype[np.float64]],
)
