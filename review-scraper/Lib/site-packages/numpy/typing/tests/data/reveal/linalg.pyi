...
assert_type(
    np.linalg.eigvals(AR_f8), npt.NDArray[np.float64] | npt.NDArray[np.complex128]
)
...
assert_type(
    np.linalg.slogdet(AR_f4_3d),
    SlogdetResult[npt.NDArray[np.float32], npt.NDArray[np.float32]],
)
assert_type(
    np.linalg.slogdet(AR_f8_3d),
    SlogdetResult[npt.NDArray[np.float64], npt.NDArray[np.float64]],
)
assert_type(
    np.linalg.slogdet(complex_list_2d), SlogdetResult[np.float64, np.complex128]
)
assert_type(
    np.linalg.slogdet(complex_list_3d),
...
assert_type(
    ...
    tuple[
        npt.NDArray[np.float64], _Array1D[np.float64], np.int32, _Array1D[np.float64]
    ],
)
assert_type(
    np.linalg.lstsq(AR_f4, AR_f4),
    tuple[
        npt.NDArray[np.float32], _Array1D[np.float32], np.int32, _Array1D[np.float32]
    ],
)
assert_type(
...
assert_type(
    ...
    tuple[
        npt.NDArray[np.complex64], _Array1D[np.float32], np.int32, _Array1D[np.float32]
    ],
)
assert_type(
    np.linalg.lstsq(AR_c8, AR_c16),
    tuple[
        npt.NDArray[np.complex128], _Array1D[np.float64], np.int32, _Array1D[np.float64]
    ],
)
assert_type(
...
assert_type(
    np.linalg.matrix_norm(complex_list_2d, keepdims=True), npt.NDArray[np.float64]
)
...
assert_type(
    np.linalg.trace(AR_f8_4d),
    np.ndarray[tuple[int, *tuple[Any, ...]], np.dtype[np.float64]],
)
