...
assert_type(np.expand_dims(AR_i8_0d, (0,)), np.ndarray[tuple[int], np.dtype[np.int64]])
assert_type(
    np.expand_dims(AR_i8_0d, (0, 1)), np.ndarray[tuple[int, int], np.dtype[np.int64]]
)
assert_type(np.expand_dims(AR_i8_1d, ()), np.ndarray[tuple[int], np.dtype[np.int64]])
assert_type(
    np.expand_dims(AR_i8_1d, 0), np.ndarray[tuple[int, int], np.dtype[np.int64]]
)
assert_type(
    np.expand_dims(AR_i8_1d, (0,)), np.ndarray[tuple[int, int], np.dtype[np.int64]]
)
assert_type(
    np.expand_dims(AR_i8_1d, (0, 1)),
    np.ndarray[tuple[int, int, int], np.dtype[np.int64]],
)
assert_type(
    np.expand_dims(AR_i8_2d, ()), np.ndarray[tuple[int, int], np.dtype[np.int64]]
)
assert_type(
    np.expand_dims(AR_i8_2d, 0), np.ndarray[tuple[int, int, int], np.dtype[np.int64]]
)
assert_type(
    np.expand_dims(AR_i8_2d, (0,)), np.ndarray[tuple[int, int, int], np.dtype[np.int64]]
)
assert_type(
    np.expand_dims(AR_i8_2d, (0, 1)),
    np.ndarray[tuple[int, int, int, int], np.dtype[np.int64]],
)
