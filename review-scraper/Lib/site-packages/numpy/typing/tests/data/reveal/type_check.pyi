...
assert_type(
    np.nan_to_num(AR_c16_2d), np.ndarray[tuple[int, int], np.dtype[np.complex128]]
)
...
assert_type(
    np.real_if_close(AR_f8_2d), np.ndarray[tuple[int, int], np.dtype[np.float64]]
)
assert_type(
    np.real_if_close(AR_c16_1d),
    np.ndarray[tuple[int], np.dtype[np.float64 | np.complex128]],
)
assert_type(
    np.real_if_close(AR_c16_2d),
    np.ndarray[tuple[int, int], np.dtype[np.float64 | np.complex128]],
)
