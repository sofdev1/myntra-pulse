...
def recursive_fill_fields[VoidArrayT: npt.NDArray[np.void]](
    input: npt.NDArray[np.void], output: VoidArrayT
) -> VoidArrayT: ...
...
#
@overload
def flatten_descr[NonVoidDTypeT: _NonVoidDType](
    ndtype: NonVoidDTypeT,
) -> tuple[tuple[Literal[""], NonVoidDTypeT]]: ...
@overload
...
@overload
def repack_fields[DTypeT: np.dtype](
    a: DTypeT, align: bool = False, recurse: bool = False
) -> DTypeT: ...
@overload
def repack_fields[ScalarT: np.generic](
    a: ScalarT, align: bool = False, recurse: bool = False
) -> ScalarT: ...
@overload
def repack_fields[ArrayT: np.ndarray](
    a: ArrayT, align: bool = False, recurse: bool = False
) -> ArrayT: ...
...
def find_duplicates[ShapeT: _Shape](
    ...
    np.ma.MaskedArray[ShapeT, np.dtype[np.void]], np.ndarray[ShapeT, np.dtype[np.int_]]
]: ...
@overload
def find_duplicates[ShapeT: _Shape](
    a: np.ma.MaskedArray[ShapeT, np.dtype[np.void]],
