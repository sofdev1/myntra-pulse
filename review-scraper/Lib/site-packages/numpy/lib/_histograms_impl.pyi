...
from numpy._typing import (ArrayLike, NDArray, _ArrayLike,
                           _ArrayLikeComplex_co, _ArrayLikeFloat64_co,
                           _ArrayLikeFloat_co, _ArrayLikeInt_co,
                           _ArrayLikeObject_co, _NestedSequence)
...
type _HistogramResult[HistT: np.generic, EdgeT: np.generic] = tuple[
    _Array1D[HistT], _Array1D[EdgeT]
]
...
def histogram[
    ScalarT: np.inexact | np.object_, WeightsT: np.bool | np.number | np.timedelta64
](
    a: _ArrayLike[ScalarT],
    bins: _BinKind | SupportsIndex | ArrayLike = 10,
    range: _Range | None = None,
