...
from typing import Never, Protocol, overload, type_check_only
...
type _ArrayLike2DFloat_co = _SupportsArray[np.dtype[_Float_co]] | Sequence[
...
type _Histogram2D[ScalarT: np.generic] = tuple[
    _Array2D[np.float64], _Array1D[ScalarT], _Array1D[ScalarT]
]
...
@overload
def tril[ScalarT: np.generic](
    m: _ArrayLike[ScalarT], k: int = 0
) -> NDArray[ScalarT]: ...
@overload
...
def vander[ScalarT: np.number | np.object_](
    x: _ArrayLike1D[ScalarT], N: int | None = None, increasing: bool = False
) -> _Array2D[ScalarT]: ...
@overload
def vander(
