...
from typing import Never, Self, SupportsIndex, final, overload
...
from numpy._typing import (ArrayLike, DTypeLike, NDArray, _AnyShape,
                           _ArrayLike, _DTypeLike, _IntLike_co,
                           _NestedSequence, _ScalarLike_co, _SupportsArray)
...
@overload  # N float
def ix_(
    arg0: list[float], /, *args: Sequence[float]
) -> tuple[NDArray[np.float64], ...]: ...
@overload  # N complex
def ix_(
    arg0: list[complex], /, *args: Sequence[complex]
) -> tuple[NDArray[np.complex128], ...]: ...
@overload  # N bytes
def ix_(
    arg0: Sequence[bytes], /, *args: Sequence[bytes]
) -> tuple[NDArray[np.bytes_], ...]: ...
@overload  # N str
def ix_(
    arg0: Sequence[str], /, *args: Sequence[str]
) -> tuple[NDArray[np.str_], ...]: ...
@overload  # fallback
def ix_(
...
def diag_indices_from(
    arr: np.ndarray[_JustAnyShape],
) -> tuple[_Int1D, _Int1D, *tuple[_Int1D, ...]]: ...
@overload  # 2d
def diag_indices_from(arr: np.ndarray[tuple[int, int]]) -> tuple[_Int1D, _Int1D]: ...
@overload  # 3d
def diag_indices_from(
    arr: np.ndarray[tuple[int, int, int]],
) -> tuple[_Int1D, _Int1D, _Int1D]: ...
@overload  # 4d
def diag_indices_from(
    arr: np.ndarray[tuple[int, int, int, int]],
) -> tuple[_Int1D, _Int1D, _Int1D, _Int1D]: ...
@overload  # >=2d (fallback)
def diag_indices_from(
    arr: np.ndarray[tuple[int, int, *tuple[int, ...]]],
) -> tuple[_Int1D, _Int1D, *tuple[_Int1D, ...]]: ...
