...
from typing import Protocol, Self, overload, override, type_check_only
...
class NpzFile(Mapping[str, NDArray[_ScalarT_co]]):
    ...
    ) -> NDArray[_ScalarT_co] | None: ...  # pyrefly: ignore[bad-override]
    @overload
    def get[T](
        self, key: str, default: NDArray[_ScalarT_co] | T, /
    ) -> (
        NDArray[_ScalarT_co] | T
