...
from numpy._typing import (_AnyShape, _ArrayLike, _ArrayLikeBool_co,
                           _ArrayLikeInt_co, _DTypeLike, _Shape)
...
class container(Generic[_ShapeT_co, _DTypeT_co]):
    ...
    def __invert__[ContainerT: _IntegralContainer](
        self: ContainerT, /
    ) -> ContainerT: ...
    ...
    @overload
    def __and__(
        self: _BoolContainer, other: _ArrayLikeBool_co, /
    ...
    __rand__ = __and__
    @overload
    def __iand__[ContainerT: _BoolContainer](
        self: ContainerT, other: _ArrayLikeBool_co, /
    ) -> ContainerT: ...
    @overload
    ...
    __rxor__ = __xor__
    @overload
    def __ixor__[ContainerT: _BoolContainer](
        self: ContainerT, other: _ArrayLikeBool_co, /
    ) -> ContainerT: ...
    @overload
    ...
    __ror__ = __or__
    @overload
    def __ior__[ContainerT: _BoolContainer](
        self: ContainerT, other: _ArrayLikeBool_co, /
    ) -> ContainerT: ...
    @overload
    ...
    def astype[ScalarT: np.generic](
        self, /, typecode: _DTypeLike[ScalarT]
    ) -> container[_ShapeT_co, np.dtype[ScalarT]]: ...
