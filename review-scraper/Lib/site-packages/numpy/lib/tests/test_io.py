...
from numpy.testing import (HAS_REFCOUNT, IS_WASM, assert_, assert_allclose,
                           assert_array_equal, assert_no_gc_cycles,
                           assert_no_warnings, assert_raises,
                           assert_raises_regex, tempdir, temppath)
...
class TestLoadTxt(LoadTxtBase):
    ...
    def test_max_rows_empty_lines(self, skip, data):
        ...
        x = np.loadtxt(data, dtype=int, skiprows=skip, delimiter=",", max_rows=3 - skip)
