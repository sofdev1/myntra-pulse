...
from typing import (Any, Concatenate, Never, Protocol, Self, SupportsIndex,
                    overload, type_check_only)

import numpy as np
from _typeshed import Incomplete
from numpy._typing import (ArrayLike, NDArray, _AnyShape, _ArrayLike,
...
@overload
def array_split(
    ary: ArrayLike, indices_or_sections: _ShapeLike, axis: SupportsIndex = 0
...
def hsplit[SplitableT: _SupportsSplitOps](
    ary: SplitableT, indices_or_sections: _ShapeLike
) -> list[SplitableT]: ...
@overload
...
def tile[ScalarT: np.generic](
    A: _ArrayLike[ScalarT], reps: _ArrayLikeInt
) -> NDArray[ScalarT]: ...
@overload
