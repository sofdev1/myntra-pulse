...
from typing import (NoReturn, Self, SupportsIndex, SupportsInt, overload,
                    override)

import numpy as np
from _typeshed import ConvertibleToInt, Incomplete
from numpy import (complex128, complexfloating, float64, floating, int32,
                   int64, object_, signedinteger, unsignedinteger)
from numpy._typing import (ArrayLike, NDArray, _ArrayLikeBool_co,
                           ...
                           _ArrayLikeUInt_co, _FloatLike_co, _NestedSequence,
                           _ScalarLike_co)

type _2Tup[T] = tuple[T, T]
type _5Tup[T] = tuple[
    T, NDArray[float64], NDArray[int32], NDArray[float64], NDArray[float64]
]
...
class poly1d:
    ...
    #
    def __init__(
        self, /, c_or_r: ArrayLike, r: bool = False, variable: str | None = None
    ) -> None: ...

    #
    @overload
    def __array__(
        self, /, t: None = None, copy: bool | None = None
    ) -> np.ndarray[tuple[int], np.dtype[Incomplete]]: ...
    @overload
    def __array__[DTypeT: np.dtype](
        self, /, t: DTypeT, copy: bool | None = None
    ...
    @overload
    def __call__(
        self, /, val: NDArray[Incomplete] | _NestedSequence[_ScalarLike_co]
    ) -> NDArray[Incomplete]: ...
