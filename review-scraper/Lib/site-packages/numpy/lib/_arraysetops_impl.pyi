...
type _IntersectResult[ScalarT: np.generic] = tuple[
    _Array1D[ScalarT], _Array1D[np.intp], _Array1D[np.intp]
]
...
#
@overload
def unique_all[ScalarT: np.generic](
    x: _ArrayLike[ScalarT],
) -> UniqueAllResult[ScalarT]: ...
@overload
def unique_all(x: ArrayLike) -> UniqueAllResult[Any]: ...

#
@overload
def unique_counts[ScalarT: np.generic](
    x: _ArrayLike[ScalarT],
) -> UniqueCountsResult[ScalarT]: ...
@overload
def unique_counts(x: ArrayLike) -> UniqueCountsResult[Any]: ...

#
@overload
def unique_inverse[ScalarT: np.generic](
    x: _ArrayLike[ScalarT],
) -> UniqueInverseResult[ScalarT]: ...
@overload
...
) -> _Array1D[_AnyScalarT]: ...  # noqa: UP047
@overload
