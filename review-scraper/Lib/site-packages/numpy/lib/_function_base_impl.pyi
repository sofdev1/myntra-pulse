...
from typing import (Never, Protocol, SupportsIndex, SupportsInt, overload,
                    type_check_only)
...
from numpy._typing import (_NumberLike_co, _ScalarLike_co, _Shape, _ShapeLike,
                           _SupportsArray)
...
type _ArrayLike1D[ScalarT: np.generic] = _SupportsArray[np.dtype[ScalarT]] | Sequence[
    ScalarT
]
...
type _ArrayMax2D[ScalarT: np.generic] = np.ndarray[
    tuple[int] | tuple[int, int], np.dtype[ScalarT]
]
# workaround for mypy and pyright not following the typing spec for overloads
type _ArrayNoD[ScalarT: np.generic] = np.ndarray[
    tuple[Never, Never, Never, Never], np.dtype[ScalarT]
]
...
type _Mesh2[ScalarT: np.generic, ScalarT1: np.generic] = tuple[
    _Array2D[ScalarT], _Array2D[ScalarT1]
]
...
type _PiecewiseFunction[ScalarT: np.generic, **Tss] = Callable[
    Concatenate[NDArray[ScalarT], Tss], ArrayLike
]
type _PiecewiseFunctions[ScalarT: np.generic, **Tss] = _SizedIterable[
    _PiecewiseFunction[ScalarT, Tss] | _ScalarLike_co
]
...
def rot90[ArrayT: np.ndarray](
    m: ArrayT, k: int = 1, axes: tuple[int, int] = (0, 1)
) -> ArrayT: ...
@overload
def rot90[ScalarT: np.generic](
    m: _ArrayLike[ScalarT], k: int = 1, axes: tuple[int, int] = (0, 1)
) -> NDArray[ScalarT]: ...
@overload
def rot90(
...
@overload
def flip[ArrayT: np.ndarray](
    m: ArrayT, axis: int | tuple[int, ...] | None = None
) -> ArrayT: ...
@overload
def flip[ScalarT: np.generic](
    m: _ArrayLike[ScalarT], axis: int | tuple[int, ...] | None = None
) -> NDArray[ScalarT]: ...
@overload
def flip(
...
#
@overload
def asarray_chkfinite[ArrayT: np.ndarray](
    a: ArrayT, dtype: None = None, order: _OrderKACF = None
) -> ArrayT: ...
@overload
...
@overload
def extract[ScalarT: np.generic](
    condition: ArrayLike, arr: _ArrayLike[ScalarT]
) -> _Array1D[ScalarT]: ...
@overload
...
def copy[ArrayT: np.ndarray](
    a: ArrayT, order: _OrderKACF, subok: L[True]
) -> ArrayT: ...
@overload
def copy[ArrayT: np.ndarray](
    a: ArrayT, order: _OrderKACF = "K", *, subok: L[True]
) -> ArrayT: ...
@overload
def copy[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], order: _OrderKACF = "K", subok: L[False] = False
) -> NDArray[ScalarT]: ...
@overload
def copy(
...
def angle[ArrayFloatingT: NDArray[np.floating]](
    z: ArrayFloatingT, deg: bool = False
) -> ArrayFloatingT: ...
@overload  # nd T: complex128 | ~integer -> nd float64
def angle[ShapeT: _Shape](
    z: _Array[ShapeT, np.complex128 | _integer_co], deg: bool = False
) -> _Array[ShapeT, np.float64]: ...
@overload  # nd T: complex64 -> nd float32
def angle[ShapeT: _Shape](
    z: _Array[ShapeT, np.complex64], deg: bool = False
) -> _Array[ShapeT, np.float32]: ...
@overload  # nd T: clongdouble -> nd longdouble
def angle[ShapeT: _Shape](
    z: _Array[ShapeT, np.clongdouble], deg: bool = False
...
def sort_complex[ShapeT: _Shape](
    a: _Array[ShapeT, np.int8 | np.uint8 | np.int16 | np.uint16],
) -> _Array[ShapeT, np.complex64]: ...
...
def sort_complex[ShapeT: _Shape](
    a: _Array[ShapeT, _SortsToComplex128],
) -> _Array[ShapeT, np.complex128]: ...
...
def sort_complex[ShapeT: _Shape](
    a: _Array[ShapeT, np.longdouble],
) -> _Array[ShapeT, np.clongdouble]: ...
...
#
@overload
def i0[ShapeT: _Shape](
    x: _Array[ShapeT, np.floating | np.integer],
) -> _Array[ShapeT, np.float64]: ...
@overload
...
@overload
def sinc[ShapeT: _Shape](
    x: _Array[ShapeT, _integer_co],
) -> _Array[ShapeT, np.float64]: ...
@overload
...
def delete[ScalarT: np.generic](
    arr: _ArrayLike[ScalarT], obj: _IndexLike, axis: None = None
) -> _Array1D[ScalarT]: ...
@overload  # known array-type, axis specified
def delete[ArrayT: np.ndarray](
    arr: ArrayT, obj: _IndexLike, axis: SupportsIndex
) -> ArrayT: ...
@overload  # known scalar-type, axis specified
def delete[ScalarT: np.generic](
    arr: _ArrayLike[ScalarT], obj: _IndexLike, axis: SupportsIndex
) -> NDArray[ScalarT]: ...
@overload  # known scalar-type, axis=None (default)
...
@overload  # known scalar-type, axis=None (default)
def insert[ScalarT: np.generic](
    arr: _ArrayLike[ScalarT], obj: _IndexLike, values: ArrayLike, axis: None = None
) -> _Array1D[ScalarT]: ...
@overload  # known array-type, axis specified
def insert[ArrayT: np.ndarray](
    arr: ArrayT, obj: _IndexLike, values: ArrayLike, axis: SupportsIndex
) -> ArrayT: ...
@overload  # known scalar-type, axis specified
def insert[ScalarT: np.generic](
    arr: _ArrayLike[ScalarT], obj: _IndexLike, values: ArrayLike, axis: SupportsIndex
) -> NDArray[ScalarT]: ...
@overload  # known scalar-type, axis=None (default)
def insert(
...
@overload  # known array type, axis specified
def append[ArrayT: np.ndarray](
    arr: ArrayT, values: ArrayT, axis: SupportsIndex
) -> ArrayT: ...
@overload  # 1d, known scalar type, axis specified
def append[ScalarT: np.generic](
    arr: _Seq1D[ScalarT], values: _Seq1D[ScalarT], axis: SupportsIndex
) -> _Array1D[ScalarT]: ...
@overload  # 2d, known scalar type, axis specified
def append[ScalarT: np.generic](
    arr: _Seq2D[ScalarT], values: _Seq2D[ScalarT], axis: SupportsIndex
) -> _Array2D[ScalarT]: ...
@overload  # 3d, known scalar type, axis specified
def append[ScalarT: np.generic](
    arr: _Seq3D[ScalarT], values: _Seq3D[ScalarT], axis: SupportsIndex
) -> _Array3D[ScalarT]: ...
@overload  # ?d, known scalar type, axis specified
def append[ScalarT: np.generic](
    arr: _SeqND[ScalarT], values: _SeqND[ScalarT], axis: SupportsIndex
) -> NDArray[ScalarT]: ...
...
def append[ScalarT: np.generic](
    arr: _ArrayLike[ScalarT], values: _ArrayLike[ScalarT], axis: None = None
) -> _Array1D[ScalarT]: ...
