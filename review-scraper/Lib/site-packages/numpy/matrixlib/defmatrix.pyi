...
type _ToIndex1 = slice | EllipsisType | NDArray[np.integer | np.bool] | _NestedSequence[
    int
] | None
type _ToIndex2 = tuple[_ToIndex1, _ToIndex1 | SupportsIndex] | tuple[
    _ToIndex1 | SupportsIndex, _ToIndex1
]
...
class matrix(np.ndarray[_ShapeT_co, _DTypeT_co]):
    ...
    def __new__(
        cls, data: ArrayLike, dtype: DTypeLike | None = None, copy: bool = True
    ) -> _Matrix[Incomplete]: ...
    ...
    @overload
    def sum[OutT: np.ndarray](
        self, axis: _ShapeLike | None, dtype: DTypeLike | None, out: OutT
    ) -> OutT: ...
    @overload
    def sum[OutT: np.ndarray](
        self,
        ...
        *,
        out: OutT,
    ) -> OutT: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    @overload
    def any[OutT: np.ndarray](
        self, axis: _ShapeLike | None = None, *, out: OutT
    ) -> OutT: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    def max[ScalarT: np.generic](
        self: NDArray[ScalarT], axis: None = None, out: None = None
    ) -> ScalarT: ...
    @overload
    ...
    @overload
    def ptp[OutT: np.ndarray](
        self, axis: _ShapeLike | None = None, *, out: OutT
    ) -> OutT: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    # keep in sync with `argmin`
    @overload  # type: ignore[override]
    def argmax[ScalarT: np.generic](
        self: NDArray[ScalarT], axis: None = None, out: None = None
    ) -> np.intp: ...
    @overload
    def argmax(self, axis: _ShapeLike, out: None = None) -> _Matrix[np.intp]: ...
    @overload
    def argmax[OutT: NDArray[np.integer | np.bool]](
        self, axis: _ShapeLike | None, out: OutT
    ) -> OutT: ...
    @overload
    def argmax[OutT: NDArray[np.integer | np.bool]](
        self, axis: _ShapeLike | None = None, *, out: OutT
    ...
    @overload  # type: ignore[override]
    def argmin[ScalarT: np.generic](
        self: NDArray[ScalarT], axis: None = None, out: None = None
    ) -> np.intp: ...
    @overload
    def argmin(self, axis: _ShapeLike, out: None = None) -> _Matrix[np.intp]: ...
    @overload
    def argmin[OutT: NDArray[np.integer | np.bool]](
        self, axis: _ShapeLike | None, out: OutT
    ) -> OutT: ...
    @overload
    def argmin[OutT: NDArray[np.integer | np.bool]](
    ...
    @overload
    def tolist[T](
        self: _Matrix[np.generic[T]],
    ) -> list[list[T]]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    @overload
    def tolist(
        self,
