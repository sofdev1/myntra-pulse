...
from typing import SupportsAbs, SupportsIndex, TypeGuard, TypeVar, overload
...
from numpy._typing import (ArrayLike, DTypeLike, NDArray, _AnyShape,
                           ...
                           _Complex128Codes, _DTypeLike, _DTypeLikeBool,
                           _Float64Codes, _IntPCodes, _NestedSequence,
                           _NumberLike_co, _ScalarLike_co, _Shape, _ShapeLike,
                           _SupportsArray, _SupportsArrayFunc, _SupportsDType)
...
from .multiarray import (_Array, arange, array, asanyarray, asarray,
                         ascontiguousarray, asfortranarray, broadcast,
...
type _Array4D[ScalarT: np.generic] = np.ndarray[
    tuple[int, int, int, int], np.dtype[ScalarT]
]
...
type _ArrayLike1DBool_co = _SupportsArray[np.dtype[np.bool]] | Sequence[
    py_bool | np.bool
]
type _ArrayLike1DInt_co = _SupportsArray[np.dtype[_Int_co]] | Sequence[int | _Int_co]
type _ArrayLike1DFloat_co = _SupportsArray[np.dtype[_Float_co]] | Sequence[
    float | _Float_co
]
type _ArrayLike1DNumber_co = _SupportsArray[np.dtype[_Number_co]] | Sequence[
    complex | _Number_co
]
...
#
@overload
def roll[ArrayT: np.ndarray](
    a: ArrayT, shift: _ShapeLike, axis: _ShapeLike | None = None
) -> ArrayT: ...
@overload
def roll[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], shift: _ShapeLike, axis: _ShapeLike | None = None
) -> NDArray[ScalarT]: ...
@overload
def roll(
...
def moveaxis[ArrayT: np.ndarray](
    a: ArrayT, source: _ShapeLike, destination: _ShapeLike
) -> ArrayT: ...
...
def indices[ScalarT: np.generic](
    dimensions: tuple[()], dtype: _DTypeLike[ScalarT], sparse: L[False] = False
) -> _Array1D[ScalarT]: ...
...
def indices[ScalarT: np.generic](
    dimensions: tuple[int], dtype: _DTypeLike[ScalarT], sparse: L[False] = False
) -> _Array2D[ScalarT]: ...
@overload  # 1d, dtype=<known>, sparse=True
def indices[ScalarT: np.generic](
    dimensions: tuple[int], dtype: _DTypeLike[ScalarT], sparse: L[True]
...
def indices[ScalarT: np.generic](
    dimensions: tuple[int, int], dtype: _DTypeLike[ScalarT], sparse: L[False] = False
) -> _Array3D[ScalarT]: ...
...
def indices[ScalarT: np.generic](
    dimensions: Sequence[int], dtype: _DTypeLike[ScalarT], sparse: L[False] = False
) -> NDArray[ScalarT]: ...
@overload  # ?d, dtype=<known>, sparse=True
def indices[ScalarT: np.generic](
    dimensions: Sequence[int], dtype: _DTypeLike[ScalarT], sparse: L[True]
...
def identity[ScalarT: np.generic](
    n: int, dtype: _DTypeLike[ScalarT], *, like: _SupportsArrayFunc | None = None
) -> _Array2D[ScalarT]: ...
