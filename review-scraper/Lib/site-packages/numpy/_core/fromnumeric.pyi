...
from typing import (Any, Literal, Never, Protocol, SupportsIndex, TypedDict,
...
from numpy import (_CastingKind, _ModeKind, _OrderACF, _OrderKACF,
                   _PartitionKind, _SortKind, _SortSide, float16, intp,
                   object_)
...
type _ArrayJustND[ScalarT: np.generic] = np.ndarray[
...
type _ArrayLikeMultiplicative_co = _DualArrayLike[
    np.dtype[np.number | np.bool | np.object_], complex
]
type _ArrayLikeNumeric_co = _DualArrayLike[
    np.dtype[np.number | np.bool | np.object_ | np.timedelta64], complex
]
...
@overload
def swapaxes[ArrayT: np.ndarray](
    a: ArrayT, axis1: SupportsIndex, axis2: SupportsIndex
) -> ArrayT: ...
@overload
def swapaxes[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], axis1: SupportsIndex, axis2: SupportsIndex
) -> NDArray[ScalarT]: ...
@overload
def swapaxes(
...
@overload
def matrix_transpose[ScalarT: np.generic](
...
def resize[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], new_shape: SupportsIndex | tuple[SupportsIndex]
) -> _Array1D[ScalarT]: ...
@overload
...
@overload
def resize[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], new_shape: _ShapeLike
) -> NDArray[ScalarT]: ...
@overload
def resize(
...
@overload
def resize[AnyShapeT: (_0D, _1D, _2D, _3D, _4D)](
    a: ArrayLike, new_shape: AnyShapeT
) -> np.ndarray[AnyShapeT]: ...
@overload
...
def squeeze[ScalarT: np.generic](
    a: ScalarT, axis: _ShapeLike | None = None
) -> ScalarT: ...
@overload
def squeeze[ScalarT: np.generic](
    a: _ArrayLike[ScalarT], axis: _ShapeLike | None = None
) -> NDArray[ScalarT]: ...
@overload
...
@overload  # +number | timedelta64 | datetime64 | object_, keepdims=True
def amax[
    ArrayT: NDArray[np.number | np.bool | np.timedelta64 | np.datetime64 | np.object_]
](
    a: ArrayT,
    axis: int | tuple[int, ...] | None = None,
    out: None = None,
