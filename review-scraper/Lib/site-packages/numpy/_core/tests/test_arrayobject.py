...
@pytest.mark.parametrize(
    "dtype", list("?bhilqnpBHILQNPefdgSUV") + ["M8[ns]", "m8[ns]", rational, rational2]
)
...
@pytest.mark.parametrize(
    "dtype,real_dt", [(">c8", ">f4"), ("c16", "f8"), ("clongdouble", "longdouble")]
)
...
@pytest.mark.parametrize(
    "ufunc,attr", [(np._core.umath.real, "real"), (np._core.umath.imag, "imag")]
)
