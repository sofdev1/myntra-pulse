...
def finalize_array_function_like[FuncLikeT: _FuncLike](
    public_api: FuncLikeT,
) -> FuncLikeT: ...

#
def verify_matching_signatures[**Tss](
    implementation: Callable[Tss, object], dispatcher: _Dispatcher[Tss]
) -> None: ...
