...
from typing import Self, SupportsIndex, SupportsInt, overload
...
from numpy._typing import _Shape, _ShapeLike, _SupportsArray, _UFunc_Nin1_Nout1
...
class chararray(ndarray[_ShapeT_co, _CharDTypeT_co]):
    ...
    @overload  # type: ignore[override]
    def __ge__(
        self: _CharArray[str_], other: U_co, /
    ) -> NDArray[np.bool]: ...  # pyrefly: ignore[bad-override]
    @overload
    def __ge__(
        self: _CharArray[bytes_], other: S_co, /
    ) -> NDArray[np.bool]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    def __add__(
        self: _CharArray[str_], other: U_co, /
    ) -> _CharArray[str_]: ...  # pyrefly: ignore[bad-override]
    @overload
    def __add__(
        self: _CharArray[bytes_], other: S_co, /
    ) -> _CharArray[bytes_]: ...  # pyright: ignore[reportIncompatibleMethodOverride]
    ...
    #
    def decode(
        self: _CharArray[bytes_], encoding: str | None = None, errors: str | None = None
    ) -> _CharArray[str_]: ...
    def encode(
        self: _CharArray[str_], encoding: str | None = None, errors: str | None = None
    ) -> _CharArray[bytes_]: ...

    #
    @overload
    def center(
        self: _CharArray[str_], width: i_co, fillchar: U_co = " "
    ) -> _CharArray[str_]: ...
    @overload
    def center(
        self: _CharArray[bytes_], width: i_co, fillchar: str | S_co = " "
    ) -> _CharArray[bytes_]: ...

    #
    @overload
    def count(
        self: _CharArray[str_], sub: U_co, start: i_co = 0, end: i_co | None = None
    ) -> NDArray[int_]: ...
    @overload
    def count(
        self: _CharArray[bytes_], sub: S_co, start: i_co = 0, end: i_co | None = None
    ) -> NDArray[int_]: ...

    #
    @overload
    def endswith(
        self: _CharArray[str_], suffix: U_co, start: i_co = 0, end: i_co | None = None
    ) -> NDArray[np.bool]: ...
    @overload
    def endswith(
        self: _CharArray[bytes_], suffix: S_co, start: i_co = 0, end: i_co | None = None
    ) -> NDArray[np.bool]: ...
    ...
    @overload
    def lstrip(
        self: _CharArray[str_], chars: U_co | None = None
    ) -> _CharArray[str_]: ...
    @overload
    def lstrip(
        self: _CharArray[bytes_], chars: S_co | None = None
    ) -> _CharArray[bytes_]: ...

    #
    @overload  # type: ignore[override]
    def partition(
        self: _CharArray[str_], sep: U_co
    ) -> _CharArray[str_]: ...  # pyrefly: ignore[bad-override]
    @overload
    def partition(
        self: _CharArray[bytes_], sep: S_co
    ) -> _CharArray[bytes_]: ...  # pyright: ignore[reportIncompatibleMethodOverride]

    #
    @overload
    def replace(
        self: _CharArray[str_], old: U_co, new: U_co, count: i_co | None = None
    ) -> _CharArray[str_]: ...
    @overload
    def replace(
        self: _CharArray[bytes_], old: S_co, new: S_co, count: i_co | None = None
    ) -> _CharArray[bytes_]: ...
    ...
    @overload
    def rsplit(
        self: _CharArray[str_], sep: U_co | None = None, maxsplit: i_co | None = None
    ) -> NDArray[object_]: ...
    @overload
    def rsplit(
        self: _CharArray[bytes_], sep: S_co | None = None, maxsplit: i_co | None = None
    ) -> NDArray[object_]: ...
    ...
    @overload
    def startswith(
        self: _CharArray[str_], prefix: U_co, start: i_co = 0, end: i_co | None = None
    ) -> NDArray[np.bool]: ...
    @overload
    def startswith(
        self: _CharArray[bytes_], prefix: S_co, start: i_co = 0, end: i_co | None = None
    ) -> NDArray[np.bool]: ...
    ...
    @overload
    def translate(
        self: _CharArray[str_], table: U_co, deletechars: U_co | None = None
    ) -> _CharArray[str_]: ...
    @overload
    def translate(
        self: _CharArray[bytes_], table: S_co, deletechars: S_co | None = None
    ) -> _CharArray[bytes_]: ...
...
def decode(
    a: S_co, encoding: str | None = None, errors: str | None = None
) -> NDArray[str_]: ...
def encode(
    a: U_co | T_co, encoding: str | None = None, errors: str | None = None
) -> NDArray[bytes_]: ...
@overload
...
@overload
def replace(
    a: U_co, old: U_co, new: U_co, count: i_co | None = -1
) -> NDArray[str_]: ...
@overload
def replace(
    a: S_co, old: S_co, new: S_co, count: i_co | None = -1
) -> NDArray[bytes_]: ...
@overload
def replace(
    a: _StringDTypeSupportsArray,
...
@overload
def replace(
    a: T_co, old: T_co, new: T_co, count: i_co = -1
) -> _StringDTypeOrUnicodeArray: ...
@overload
...
@overload
def rsplit(
    a: U_co, sep: U_co | None = None, maxsplit: i_co | None = None
) -> NDArray[object_]: ...
@overload
def rsplit(
    a: S_co, sep: S_co | None = None, maxsplit: i_co | None = None
) -> NDArray[object_]: ...
@overload
def rsplit(
    a: _StringDTypeSupportsArray,
...
@overload
def rsplit(
    a: T_co, sep: T_co | None = None, maxsplit: i_co | None = None
) -> NDArray[object_]: ...
@overload
...
@overload
def translate(
    a: S_co, table: str, deletechars: str | None = None
) -> NDArray[bytes_]: ...
@overload
def translate(
    a: _StringDTypeSupportsArray, table: str, deletechars: str | None = None
) -> _StringDTypeArray: ...
@overload
def translate(
    a: T_co, table: str, deletechars: str | None = None
) -> _StringDTypeOrUnicodeArray: ...
@overload
...
@overload
def count(
    a: U_co, sub: U_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[int_]: ...
@overload
def count(
    a: S_co, sub: S_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[int_]: ...
@overload
def count(
    a: T_co, sub: T_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[np.int_]: ...
@overload
def endswith(
    a: U_co, suffix: U_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[np.bool]: ...
@overload
def endswith(
    a: S_co, suffix: S_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[np.bool]: ...
@overload
def endswith(
    a: T_co, suffix: T_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[np.bool]: ...
@overload
def find(
    a: U_co, sub: U_co, start: i_co = 0, end: i_co | None = None
...
@overload
def startswith(
    a: U_co, prefix: U_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[np.bool]: ...
@overload
def startswith(
    a: S_co, prefix: S_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[np.bool]: ...
@overload
def startswith(
    a: T_co, prefix: T_co, start: i_co = 0, end: i_co | None = None
) -> NDArray[np.bool]: ...
