...
from numpy._typing import (ArrayLike, DTypeLike, NDArray, _ArrayLike,
                           _ArrayLikeFloat_co, _ArrayLikeInt_co, _DTypeLike,
                           _Float32Codes, _Float64Codes, _FloatLike_co,
                           _Int64Codes, _NestedSequence, _ShapeLike)
...
class Generator:
    ...
    def random(
        self, size: None = None, dtype: _DTypeLikeFloat = ..., out: None = None
    ) -> float: ...
    @overload  # size=<given>, dtype=f64 (default)
    def random(
        self, size: _ShapeLike, dtype: _DTypeLikeF64 = ..., out: None = None
    ) -> _ArrayF64: ...
    @overload  # size=<given>, dtype=f32
    def random(
        self, size: _ShapeLike, dtype: _DTypeLikeF32, out: None = None
    ) -> _ArrayF32: ...
    ...
    def random[ArrayT: _ArrayF64](
        self, size: _ShapeLike | None, dtype: _DTypeLikeF64, out: ArrayT
    ) -> ArrayT: ...
    @overload  # dtype: f32 (positional), out: f32 array
    def random[ArrayT: _ArrayF32](
        self, size: _ShapeLike | None, dtype: _DTypeLikeF32, out: ArrayT
    ) -> ArrayT: ...
    ...
    @overload  # >=0d
    def pareto(
        self, /, a: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64 | Any: ...
    ...
    @overload  # 0d (default)
    def exponential(
        self, /, scale: _FloatLike_co = 1.0, size: None = None
    ) -> float: ...
    @overload  # size=<given> (keyword)
    def exponential(
        self, /, scale: _ArrayLikeFloat_co = 1.0, *, size: _ShapeLike
    ) -> _ArrayF64: ...
    @overload  # size=<given> (positional)
    def exponential(
        self, /, scale: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> _ArrayF64: ...
    @overload  # >0d
    def exponential(
        self, /, scale: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >=0d
    def exponential(
        self, /, scale: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64 | Any: ...
    ...
    @overload  # size=<given>
    def noncentral_chisquare(
        self, /, df: _ArrayLikeFloat_co, nonc: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> _ArrayF64: ...
    @overload  # >=0d, >0d
    def noncentral_chisquare(
        self, /, df: _ArrayLikeFloat_co, nonc: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >0d, >=0d
    def noncentral_chisquare(
        self, /, df: _NDArrayLikeFloat, nonc: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >=0d, >=0d
    def noncentral_chisquare(
        self, /, df: _ArrayLikeFloat_co, nonc: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64 | Any: ...
    ...
    @overload  # >=0d, >0d
    def f(
        self, /, dfnum: _ArrayLikeFloat_co, dfden: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >0d, >=0d
    def f(
        self, /, dfnum: _NDArrayLikeFloat, dfden: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >=0d, >=0d (fallback)
    def f(
        self, /, dfnum: _ArrayLikeFloat_co, dfden: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64 | Any: ...
    ...
    @overload  # >=0d, >0d
    def vonmises(
        self, /, mu: _ArrayLikeFloat_co, kappa: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >0d, >=0d
    def vonmises(
        self, /, mu: _NDArrayLikeFloat, kappa: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >=0d, >=0d (fallback)
    def vonmises(
        self, /, mu: _ArrayLikeFloat_co, kappa: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64 | Any: ...
    ...
    @overload  # >=0d, >0d
    def wald(
        self, /, mean: _ArrayLikeFloat_co, scale: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >0d, >=0d
    def wald(
        self, /, mean: _NDArrayLikeFloat, scale: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >=0d, >=0d (fallback)
    def wald(
        self, /, mean: _ArrayLikeFloat_co, scale: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64 | Any: ...

    #
    @overload  # 0d, 0d
    def beta(
        self, /, a: _FloatLike_co, b: _FloatLike_co, size: None = None
    ) -> float: ...
    @overload  # size=<given>
    def beta(
        self, /, a: _ArrayLikeFloat_co, b: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> _ArrayF64: ...
    @overload  # >=0d, >0d
    def beta(
        self, /, a: _ArrayLikeFloat_co, b: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >0d, >=0d
    def beta(
        self, /, a: _NDArrayLikeFloat, b: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >=0d, >=0d (fallback)
    def beta(
        self, /, a: _ArrayLikeFloat_co, b: _ArrayLikeFloat_co, size: None = None
    ) -> _ArrayF64 | Any: ...
    ...
    @overload  # >=0d, >0d
    def gamma(
        self, /, shape: _ArrayLikeFloat_co, scale: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # >0d, >=0d
    def gamma(
        self,
    ...
    def uniform(
        self, /, low: _FloatLike_co = 0.0, high: _FloatLike_co = 1.0, size: None = None
    ) -> float: ...
    ...
    def uniform(
        self, /, low: _ArrayLikeFloat_co, high: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    ...
    @overload  # 0d (default), 0d (default)
    def normal(
        self, /, loc: _FloatLike_co = 0.0, scale: _FloatLike_co = 1.0, size: None = None
    ) -> float: ...
    @overload  # size=<given> (positional)
    def normal(
    ...
    @overload  # >=0d, >0d (positional)
    def normal(
        self, /, loc: _ArrayLikeFloat_co, scale: _NDArrayLikeFloat, size: None
    ) -> _ArrayF64: ...
    @overload  # size=<given> (keyword)
    def normal(
        self,
    ...
    @overload  # >=0d, >0d (positional)
    def lognormal(
        self, /, mean: _ArrayLikeFloat_co, sigma: _NDArrayLikeFloat, size: None = None
    ) -> _ArrayF64: ...
    @overload  # size=<given> (keyword)
    def lognormal(
        self,
    ...
    @overload  # size=<given>
    def geometric(
        self, /, p: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> NDArray[np.int64]: ...
    @overload  # >0d
    def geometric(
        self, /, p: _NDArrayLikeFloat, size: None = None
    ) -> NDArray[np.int64]: ...
    @overload  # >=0d
    def geometric(
        self, /, p: _ArrayLikeFloat_co, size: None = None
    ) -> NDArray[np.int64] | Any: ...
    ...
    @overload  # size=<given> (keyword)
    def poisson(
        self, /, lam: _ArrayLikeFloat_co = 1.0, *, size: _ShapeLike
    ) -> NDArray[np.int64]: ...
    @overload  # size=<given> (positional)
    def poisson(
        self, /, lam: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> NDArray[np.int64]: ...
    @overload  # >0d
    def poisson(
        self, /, lam: _NDArrayLikeFloat, size: None = None
    ) -> NDArray[np.int64]: ...
    @overload  # >=0d
    def poisson(
        self, /, lam: _ArrayLikeFloat_co, size: None = None
    ) -> NDArray[np.int64] | Any: ...
    ...
    @overload  # size=<given>
    def binomial(
        self, /, n: _ArrayLikeInt_co, p: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> NDArray[np.int64]: ...
    @overload  # >=0d, >0d
    def binomial(
        self, /, n: _ArrayLikeInt_co, p: _NDArrayLikeFloat, size: None = None
    ) -> NDArray[np.int64]: ...
    @overload  # >0d, >=0d
    def binomial(
        self, /, n: _NDArrayLikeInt, p: _ArrayLikeFloat_co, size: None = None
    ) -> NDArray[np.int64]: ...
    @overload  # >=0d, >=0d
    def binomial(
        self, /, n: _ArrayLikeInt_co, p: _ArrayLikeFloat_co, size: None = None
    ) -> NDArray[np.int64] | Any: ...
    ...
    @overload  # >=0d, >0d
    def negative_binomial(
        self, /, n: _ArrayLikeFloat_co, p: _NDArrayLikeFloat, size: None = None
    ) -> NDArray[np.int64]: ...
    @overload  # >0d, >=0d
    def negative_binomial(
        self, /, n: _NDArrayLikeFloat, p: _ArrayLikeFloat_co, size: None = None
    ) -> NDArray[np.int64]: ...
    @overload  # >=0d, >=0d
    def negative_binomial(
    ...
    #
    @overload
    def permuted[ArrayT: np.ndarray](
        self, /, x: ArrayT, *, axis: int | None = None, out: None = None
    ) -> ArrayT: ...
    @overload
    def permuted(
        self, /, x: ArrayLike, *, axis: int | None = None, out: None = None
    ) -> np.ndarray: ...
    @overload
    def permuted[ArrayT: np.ndarray](
        self, /, x: ArrayLike, *, axis: int | None = None, out: ArrayT
    ) -> ArrayT: ...
