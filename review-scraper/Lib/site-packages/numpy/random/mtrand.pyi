...
from numpy._typing import (ArrayLike, NDArray, _ArrayLikeFloat_co,
                           _ArrayLikeInt_co, _BoolCodes, _DTypeLike,
                           _DTypeLikeBool, _DTypeLikeInt, _Int8Codes,
                           _Int16Codes, _Int32Codes, _Int64Codes, _IntPCodes,
                           _ShapeLike, _UInt8Codes, _UInt16Codes, _UInt32Codes,
...
class RandomState:
    ...
    ) -> dict[str, Any] | tuple[str, NDArray[np.uint32], int, int, float]: ...

    #
    def set_state(
        self, state: dict[str, Any] | tuple[str, NDArray[np.uint32], int, int, float]
    ) -> None: ...
    ...
    @overload
    def exponential(
        self, scale: _ArrayLikeFloat_co = 1.0, size: None = None
    ) -> NDArray[np.float64] | Any: ...
    ...
    @overload
    def standard_gamma(
        self, shape: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> NDArray[np.float64]: ...
    @overload
    def standard_gamma(
        self, shape: _ArrayLikeFloat_co, size: None = None
    ) -> NDArray[np.float64] | Any: ...
    ...
    @overload
    def pareto(
        self, a: _ArrayLikeFloat_co, size: _ShapeLike
    ) -> NDArray[np.float64]: ...
    @overload
    def pareto(
    ...
    @overload
    def poisson(
        self, lam: _ArrayLikeFloat_co = 1.0, size: None = None
    ) -> NDArray[np.long] | Any: ...
