...
class Commit(base.Object, TraversableIterableObj, Diffable, Serializable):
        ...
        **kwargs: Any,
        ...
        if not allow_unsafe_options:
            Git.check_unsafe_options(
                ...
                unsafe_options=self.unsafe_git_rev_options,
            )
        ...
        **kwargs: Any,
        ...
        if not allow_unsafe_options:
            Git.check_unsafe_options(
                ...
                unsafe_options=cls.unsafe_git_rev_options,
            )
    ...
    def trailers_list(self) -> List[Tuple[str, str]]:
        ...
        """
        trailer = self._interpret_trailers(
            self.repo, self.message, ["--parse"], encoding=self.encoding
        ).strip()
    ...
    def _interpret_trailers(
        ...
        message_bytes = (
            ...
            else message.encode(encoding, errors="strict")
        )
