...
try:
    ...
    from git.diff import Diffable  # @NoMove
    from git.diff import INDEX, NULL_TREE, Diff, DiffConstants, DiffIndex
    ...
    from git.objects import Object  # @NoMove
    ...
    from git.refs import RefLog  # @NoMove
    ...
    from git.util import Stats  # @NoMove
