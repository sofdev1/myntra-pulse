...
from .schema._typing import (Map, PrimitiveValue_T, SingleDefUnitChannel_T,
                             Temporal)
...
if sys.version_info >= (3, 12):
    ...
    from typing_extensions import (Protocol, TypeAliasType,  # noqa: F401
                                   runtime_checkable)
...
if TYPE_CHECKING:
    ...
    from altair.expr.core import (BinaryExpression, Expression,
                                  GetAttrExpression, GetItemExpression,
                                  IntoExpression)
    from altair.utils.display import MimeBundleType

    from .schema._config import (BrushConfigKwds, DerivedStreamKwds,
                                 MergedStreamKwds)
    from .schema._typing import (AggregateOp_T, AutosizeType_T, ColorName_T,
                                 CompositeMark_T, ImputeMethod_T,
                                 LayoutAlign_T, Mark_T, MultiTimeUnit_T,
                                 OneOrSeq, ProjectionType_T, ResolveMode_T,
                                 SelectionResolution_T, SelectionType_T,
                                 SingleTimeUnit_T, StackOffset_T)
    from .schema.channels import Column, Facet, Row
    from .schema.core import (AggregatedFieldDef, AggregateOp, AnyMark,
                              BindCheckbox, Binding, BindInput,
                              BindRadioSelect, BindRange, BinParams,
                              BrushConfig, DateTime, Expr, ExprRef,
                              FacetedEncoding, FacetFieldDef, FieldName,
                              GraticuleGenerator, ImputeMethod, ImputeSequence,
                              InlineData, InlineDataset,
                              IntervalSelectionConfig, JoinAggregateFieldDef,
                              LayerRepeatMapping, LookupSelection, NamedData,
                              ParameterName, PointSelectionConfig,
                              PredicateComposition, ProjectionType,
                              RepeatMapping, RepeatRef, SelectionParameter,
                              SequenceGenerator, SortField, SphereGenerator,
                              Step, TimeUnit, TopLevelSelectionParameter,
                              Transform, UrlData, VariableParameter,
                              Vector2number, Vector2Vector2number,
                              Vector3number, WindowFieldDef)
