...
from pip._vendor.packaging.direct_url import ArchiveInfo
from pip._vendor.packaging.direct_url import DirectUrl as PackagingDirectUrl
from pip._vendor.packaging.direct_url import DirectUrlValidationError, DirInfo, VcsInfo
