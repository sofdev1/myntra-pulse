...
from streamlit.elements.lib.utils import Key, maybe_coerce_enum_sequence, to_key
    ...
    def _internal_button_group(
        ...
        *,
        ...
        res = self._button_group(
            ...
            click_mode=(
                ButtonGroupProto.ClickMode.MULTI_SELECT
    ...
    def _button_group(
        ...
        *,
        ...
        after_register_callback: (
            Callable[[RegisterWidgetResult[T]], RegisterWidgetResult[T]] | None
        ) = None,
