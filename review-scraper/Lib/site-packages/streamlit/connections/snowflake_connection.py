...
if TYPE_CHECKING:
    ...
    from snowflake.connector.cursor import \
        SnowflakeCursor  # type:ignore[import]
...
class SnowflakeConnection(BaseConnection["InternalSnowflakeConnection"]):
    ...
    def _connect(self, **kwargs) -> InternalSnowflakeConnection:
        ...
        from snowflake.connector import \
            Error as SnowflakeError  # type:ignore[import]
    ...
    def query(
        ...
        **kwargs,
        ...
        from snowflake.connector.errors import \
            ProgrammingError  # type: ignore[import]
        from snowflake.connector.network import (  # type: ignore[import]
            BAD_REQUEST_GS_CODE, ID_TOKEN_EXPIRED_GS_CODE,
            MASTER_TOKEN_EXPIRED_GS_CODE, MASTER_TOKEN_INVALD_GS_CODE,
            MASTER_TOKEN_NOTFOUND_GS_CODE, SESSION_EXPIRED_GS_CODE)
    ...
    def write_pandas(
        ...
        **kwargs,
        ...
        from snowflake.connector.pandas_tools import \
            write_pandas  # type:ignore[import]
    ...
    def session(self) -> Session:
        ...
        from snowflake.snowpark.context import \
            get_active_session  # type:ignore[import]
        from snowflake.snowpark.session import Session  # type:ignore[import]
